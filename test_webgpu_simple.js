...
async function testBackend() {
  try {
    ...
    const result = await getParakeetModel(
    ...
    console.log("✓ Model files retrieved:", Object.keys(result.urls));
    ...
    // Flatten result.urls to top level where fromUrls expects them
