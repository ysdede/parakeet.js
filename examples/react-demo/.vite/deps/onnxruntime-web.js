...
var require_ort_min = __commonJS({
  "../../node_modules/onnxruntime-web/dist/ort.min.js"(exports, module) {
    var ort = (() => {
      ...
      var yn = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof __require < "u" ? __require : t)[n] }) : e)(function(e) {
      ...
      var Ye = (e, t) => {
        for (var n in t)
          gn(e, n, { get: t[n], enumerable: true });
      }, Nu = (e, t, n, r) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let o of Uu(t))
            !Vu.call(e, o) && o !== n && gn(e, o, { get: () => t[o], enumerable: !(r = Ru(t, o)) || r.enumerable });
        return e;
      };
      var it = (e) => Nu(gn({}, "__esModule", { value: true }), e);
      var _t, Ge, Ue, Lu, fr, bn = E(() => {
        "use strict";
        _t = /* @__PURE__ */ new Map(), Ge = [], Ue = (e, t, n) => {
          if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
            let r = _t.get(e);
            if (r === void 0)
              _t.set(e, { backend: t, priority: n });
            else {
              if (r.priority > n)
                return;
          ...
          let t = e.executionProviders || [], n = t.map((u) => typeof u == "string" ? u : u.name), r = n.length === 0 ? Ge : n, o, i = [], s = /* @__PURE__ */ new Set();
          for (let u of r) {
            let d = await Lu(u);
      ...
      var gr, yr = E(() => {
        "use strict";
        gr = "1.22.0-dev.20250409-89f8206ba4";
      });
      var br, ye, _n = E(() => {
        "use strict";
        yr();
        br = "warning", ye = { wasm: {}, webgl: {}, webgpu: {}, versions: { common: gr }, set logLevel(e) {
          if (e !== void 0) {
        ...
        Object.defineProperty(ye, "logLevel", { enumerable: true });
      });
      var J, _r = E(() => {
        "use strict";
        _n();
      ...
      var wn, xr, Sr, Tr, Ir, Cr, Ar = E(() => {
        ...
        wn = (e, t) => {
          ...
          if (n) {
            ...
            if (c != null) {
              let p = e.height, f = e.width;
              return c.drawImage(e, 0, 0, f, p), s = c.getImageData(0, 0, f, p).data, a.height = p, a.width = f, wn(s, a);
            } else
              throw new Error("Can not access image data");
          } else {
            if (i)
              return new Promise((l, c) => {
                ...
                m.crossOrigin = "Anonymous", m.src = e, m.onload = () => {
                  ...
                  a.height = p.height, a.width = p.width, l(wn(h.data, a));
                };
              });
        ...
        }, Cr = (e, t, n) => new pe({ location: "cpu-pinned", type: e, data: t, dims: n ?? [t.length] });
      });
      var He, st, Er, kr, Pr = E(() => {
        "use strict";
        He = /* @__PURE__ */ new Map([["float32", Float32Array], ["uint8", Uint8Array], ["int8", Int8Array], ["uint16", Uint16Array], ["int16", Int16Array], ["int32", Int32Array], ["bool", Uint8Array], ["float64", Float64Array], ["uint32", Uint32Array], ["int4", Uint8Array], ["uint4", Uint8Array]]), st = /* @__PURE__ */ new Map([[Float32Array, "float32"], [Uint8Array, "uint8"], [Int8Array, "int8"], [Uint16Array, "uint16"], [Int16Array, "int16"], [Int32Array, "int32"], [Float64Array, "float64"], [Uint32Array, "uint32"]]), Er = false, kr = () => {
          if (!Er) {
            Er = true;
            ...
            e && (He.set("int64", BigInt64Array), st.set(BigInt64Array, "int64")), t && (He.set("uint64", BigUint64Array), st.set(BigUint64Array, "uint64")), r ? (He.set("float16", n), st.set(n, "float16")) : He.set("float16", Uint16Array);
          }
        };
      });
      var zr, Br, Or = E(() => {
      ...
      var at, Dr, he, fe, vn = E(() => {
        "use strict";
        _n();
        at = (e, t) => {
          (typeof ye.trace > "u" ? !ye.wasm.trace : !ye.trace) || console.timeStamp(`${e}::ORT::${t}`);
        }, Dr = (e, t) => {
          var _a2;
          ...
          (typeof ye.trace > "u" ? !ye.wasm.trace : !ye.trace) || Dr("BEGIN", e);
        }, fe = (e) => {
          (typeof ye.trace > "u" ? !ye.wasm.trace : !ye.trace) || Dr("END", e);
        };
      });
      var $t, Mr = E(() => {
        "use strict";
        ...
        $t = class e {
          ...
          static async create(t, n, r, o) {
            ...
            let [a, u] = await fr(s), d = await a.createInferenceSessionHandler(i, u);
            return fe(), new e(d);
          }
          startProfiling() {
      ...
      var xn = {};
      Ye(xn, { InferenceSession: () => Rr, TRACE: () => at, TRACE_FUNC_BEGIN: () => he, TRACE_FUNC_END: () => fe, Tensor: () => we, env: () => J, registerBackend: () => Ue });
      var $e = E(() => {
        "use strict";
        hr();
        _r();
      ...
      var Hr, qr, Wu, Kr = E(() => {
        ...
        Ve();
        xt();
        Hr = "ort-wasm-proxy-worker", qr = ((_a2 = globalThis.self) == null ? void 0 : _a2.name) === Hr;
        qr && (self.onmessage = (e) => {
          ...
          try {
            switch (t) {
              ...
              case "release":
                At(n), postMessage({ type: t });
                break;
              case "run": {
                let { sessionId: r, inputIndices: o, inputs: i, outputIndices: s, options: a } = n;
                Et(r, o, i, s, new Array(s.length).fill(null), a).then((u) => {
                  u.some((d) => d[3] !== "cpu") ? postMessage({ type: t, err: "Proxy does not support non-cpu tensor location." }) : postMessage({ type: t, out: u }, Pt([...i, ...u]));
                }, (u) => {
        ...
        Wu = qr ? null : (e) => new Worker(e ?? be, { type: "classic", name: Hr });
      });
      var Gu, Hu, be, zt, Tn, qu, Fu, Qr, Ku, jr, Xr, Zr, Yr, xt = E(() => {
        "use strict";
        vt();
        Gu = typeof location > "u" ? void 0 : location.origin, Hu = () => {
          var _a2, _b;
          if (true)
          ...
          try {
            let n = t ?? be;
            return (n ? new URL(e, n) : new URL(e)).origin === Gu;
          } catch {
            return false;
          }
        }, qu = (e, t) => {
        ...
        }, Fu = (e, t) => `${t ?? "./"}${e}`, Qr = async (e) => {
          let n = await (await fetch(e, { credentials: "same-origin" })).blob();
          return URL.createObjectURL(n);
        }, Ku = async (e) => (await import(
          /*webpackIgnore:true*/
          e
        )).default, jr = (Kr(), it(Fr)).default, Xr = async () => {
          if (!be)
          ...
          let e = await Qr(be);
          return [e, jr(e)];
        }, Zr = void 0, Yr = async (e, t, n) => {
          if (!e && !t && Zr && be && Tn(be))
            return [void 0, Zr];
          {
            let r = "ort-wasm-simd-threaded.jsep.mjs", o = e ?? qu(r, t), i = n && o && !Tn(o, t), s = i ? await Qr(o) : o ?? Fu(r, t);
            return [i ? s : void 0, await Ku(s)];
          }
        };
      });
      var In, Cn, Bt, Jr, ju, Zu, Qu, St, ee, Ve = E(() => {
        "use strict";
        xt();
        Cn = false, Bt = false, Jr = false, ju = () => {
          ...
          let o = e.wasmPaths, i = typeof o == "string" ? o : void 0, s = o == null ? void 0 : o.mjs, a = (s == null ? void 0 : s.href) ?? s, u = o == null ? void 0 : o.wasm, d = (u == null ? void 0 : u.href) ?? u, l = e.wasmBinary, [c, p] = await Yr(a, i, n > 1), f = false, m = [];
          if (t > 0 && m.push(new Promise((h) => {
            ...
            p(y).then((g) => {
              Bt = false, Cn = true, In = g, h(), c && URL.revokeObjectURL(c);
            }, (g) => {
              Bt = false, Jr = true, b(g);
            });
      ...
      var _e, dt, X, Ot = E(() => {
        ...
        Ve();
        _e = (e, t) => {
          let n = ee(), r = n.lengthBytesUTF8(e) + 1, o = n._malloc(r);
      ...
      var eo, to = E(() => {
        ...
        eo = (e) => {
          ...
          try {
            ...
            let i = 0;
            return (e == null ? void 0 : e.tag) !== void 0 && (i = _e(e.tag, r)), n = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), n === 0 && X("Can't create run options."), (e == null ? void 0 : e.extra) !== void 0 && dt(e.extra, "", /* @__PURE__ */ new WeakSet(), (s, a) => {
              let u = _e(s, r), d = _e(a, r);
              t._OrtAddRunConfigEntry(n, u, d) !== 0 && X(`Can't set a run config entry: ${s} - ${a}.`);
            }), [n, r];
          } catch (i) {
      ...
      var Xu, Yu, Ju, Dt, ed, no, ro = E(() => {
        ...
        Xu = (e) => {
          ...
          ee()._OrtAddSessionConfigEntry(e, o, i) !== 0 && X(`Can't set a session config entry: ${t} - ${n}.`);
        }, ed = async (e, t, n) => {
          for (let r of t) {
              ...
              case "webgpu":
                if (o = "JS", typeof r != "string") {
                  ...
                  if (l == null ? void 0 : l.preferredLayout) {
                    ...
                    Dt(e, "preferredLayout", l.preferredLayout, n);
                  }
                }
                break;
              case "wasm":
            ...
            if (a > 0) {
              u = ee()._malloc(a * ee().PTR_SIZE), n.push(u), d = ee()._malloc(a * ee().PTR_SIZE), n.push(d);
              for (let l = 0; l < a; l++)
                ee().setValue(u + l * ee().PTR_SIZE, i[l][0], "*"), ee().setValue(d + l * ee().PTR_SIZE, i[l][1], "*");
            }
            await ee()._OrtAppendExecutionProvider(e, s, u, d, a) !== 0 && X(`Can't append execution provider: ${o}.`);
          }
        }, no = async (e) => {
          let t = ee(), n = 0, r = [], o = e || {};
          Ju(o);
          try {
            let i = Xu(o.graphOptimizationLevel ?? "all"), s = Yu(o.executionMode ?? "sequential"), a = typeof o.logId == "string" ? _e(o.logId, r) : 0, u = o.logSeverityLevel ?? 2;
            ...
            if (n = t._OrtCreateSessionOptions(i, !!o.enableCpuMemArena, !!o.enableMemPattern, s, !!o.enableProfiling, 0, a, u, d, l), n === 0 && X("Can't create session options."), o.executionProviders && await ed(n, o.executionProviders, r), o.enableGraphCapture !== void 0) {
              if (typeof o.enableGraphCapture != "boolean")
                throw new Error(`enableGraphCapture must be a boolean value: ${o.enableGraphCapture}`);
              Dt(n, "enableGraphCapture", o.enableGraphCapture.toString(), r);
            }
            if (o.freeDimensionOverrides)
              for (let [c, p] of Object.entries(o.freeDimensionOverrides)) {
                ...
                let f = _e(c, r);
                t._OrtAddFreeDimensionOverride(n, f, p) !== 0 && X(`Can't set a free dimension override: ${c} - ${p}.`);
              }
            return o.extra !== void 0 && dt(o.extra, "", /* @__PURE__ */ new WeakSet(), (c, p) => {
              Dt(n, c, p, r);
            }), [n, r];
          } catch (i) {
            throw n !== 0 && t._OrtReleaseSessionOptions(n) !== 0 && X("Can't release session options."), r.forEach((s) => t._free(s)), i;
          }
        };
      });
      var Je, Ce, Ne, Mt, lt, Rt, Ut, An, L = E(() => {
        "use strict";
        Je = (e) => {
          switch (e) {
            case "int8":
        ...
        }, Rt = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", Ut = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint64" || e === "int8" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", An = (e) => {
          switch (e) {
            case "none":
              return 0;
            case "cpu":
      ...
      var ct, En = E(() => {
        ...
        ct = async (e) => {
          if (typeof e == "string")
            if (false)
              try {
                let { readFile: t } = yn("node:fs/promises");
                return new Uint8Array(await t(e));
              } catch (t) {
                if (t.code === "ERR_FS_FILE_TOO_LARGE") {
                  let { createReadStream: n } = yn("node:fs"), r = n(e), o = [];
      ...
      var td, nd, oo, io, Vt, rd, Z, Ae = E(() => {
        "use strict";
        L();
        td = ["V", "I", "W", "E", "F"], nd = (e, t) => {
          console.log(`[${td[e]},${(/* @__PURE__ */ new Date()).toISOString()}]${t}`);
        }, Vt = (e, t) => {
          oo = e, io = t;
        }, rd = (e, t) => {
          let n = lt(e), r = lt(oo);
          n >= r && nd(n, typeof t == "function" ? t() : t);
        }, Z = (...e) => {
          io && rd(...e);
        };
      });
      var kn, Ee, x, Fe, Nt, so, ao, q = E(() => {
        "use strict";
        kn = class {
          ...
          static calcShape(t, n, r = false) {
            ...
            if (r) {
              if (o < 2 || i < 2)
                return;
              let u = kn.calcMatMulShape([t[o - 2], t[o - 1]], [n[i - 2], n[i - 1]]);
              if (u === void 0)
                return;
              [a[s - 2], a[s - 1]] = u;
            }
          ...
          static getShapeOfGemmResult(t, n, r, o, i) {
            ...
            if (i && !Ee.isValidBroadcast(i, [s, u]))
      ...
      var Bn, lo, od, uo, id, co, Wt, Gt, zn, po, mo = E(() => {
        "use strict";
        Ae();
        Bn = (e, t = true) => {
          if (e.byteLength % 8 !== 0)
            throw new Error("Invalid Uint8Array length - must be a multiple of 8 (BigInt).");
          let n = e.byteLength / 8, r = new BigInt64Array(e.buffer, e.byteOffset, n), o = new Int32Array(n);
          for (let i = 0; i < n; i++) {
            let s = r[i];
            if (s > 2147483647n || s < -2147483648n)
              throw new Error(`Overflow occurred when converting BigInt to Int32 at index ${i}: ${s}`);
            o[i] = Number(s);
          }
          ...
          let n = e.byteLength / 4, r = new Int32Array(e.buffer, e.byteOffset, n), o = BigInt64Array.from(r, BigInt);
          return t ? new Uint8Array(o.buffer) : o;
        }, od = 1, uo = () => od++, id = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), co = (e, t) => {
          let n = id.get(e);
          if (!n)
          ...
          constructor(t) {
            ...
            let { sessionId: n, context: r, tensor: o, dataType: i, shape: s, shouldConvertInt64toInt32: a = false } = t;
            this.sessionId = n, this.mlContext = r, this.mlTensor = o, this.dataType = i, this.tensorShape = s, this.shouldConvertInt64toInt32 = a;
          }
          get tensor() {
          ...
          get byteLength() {
            return co(this.dataType, this.tensorShape);
          }
          destroy() {
          ...
          async read(t, n) {
            if (t) {
              let r = await this.mlContext.readTensor(this.mlTensor), o = lo(new Uint8Array(r));
              if (n) {
                (n instanceof ArrayBuffer ? new Uint8Array(n) : new Uint8Array(n.buffer, n.byteOffset, n.byteLength)).set(o);
                return;
              } else
                return o.buffer;
            } else
              return n ? this.mlContext.readTensor(this.mlTensor, n) : this.mlContext.readTensor(this.mlTensor);
          }
          ...
          async ensureTensor(t, n, r, o) {
            let i = n, s = this.tensorManager.getMLContext(t), a = i === "int64" && !s.opSupportLimits().input.dataTypes.includes("int64");
            if (a && (i = "int32", Z("verbose", () => "[WebNN] TensorIdTracker.ensureTensor: convert dataType from int64 to int32")), this.wrapper) {
              if (this.wrapper.canReuseTensor(s, i, r))
                return this.wrapper.tensor;
              if (o) {
                if (this.wrapper.byteLength !== co(i, r))
            ...
            return this.wrapper = await this.tensorManager.getCachedTensor(t, i, r, u, true, true, a), o && this.activeUpload && (this.wrapper.write(this.activeUpload), this.activeUpload = void 0), this.wrapper.tensor;
          }
          upload(t) {
            let n = t;
            if (this.wrapper)
              if (this.wrapper.shouldConvertInt64toInt32 && (n = Bn(t, true), this.wrapper.setIsInt64ToInt32Converted(true)), n.byteLength === this.wrapper.byteLength) {
          ...
          async download(t) {
            ...
            if (this.activeUpload) {
              let n = ((_a2 = this.wrapper) == null ? void 0 : _a2.isInt64ToInt32Converted) ? lo(this.activeUpload) : this.activeUpload;
              if (t) {
            ...
            return t ? this.wrapper.read((_b = this.wrapper) == null ? void 0 : _b.shouldConvertInt64toInt32, t) : this.wrapper.read((_c2 = this.wrapper) == null ? void 0 : _c2.shouldConvertInt64toInt32);
          }
        }, zn = class {
          constructor(t) {
            this.backend = t;
          ...
          reserveTensorId() {
            let t = uo();
            return this.tensorTrackersById.set(t, new Gt(this)), t;
          }
          releaseTensorId(t) {
          ...
          registerTensor(t, n, r, o) {
            let i = this.getMLContext(t), s = uo(), a = new Wt({ sessionId: t, context: i, tensor: n, dataType: r, shape: o });
            return this.tensorTrackersById.set(s, new Gt(this, a)), this.externalTensors.add(a), s;
          }
          async getCachedTensor(t, n, r, o, i, s, a = false) {
            let u = this.getMLContext(t);
            for (let [l, c] of this.freeTensors.entries())
              if (c.canReuseTensor(u, n, r)) {
                Z("verbose", () => `[WebNN] Reusing tensor {dataType: ${n}, shape: ${r}}`);
                let p = this.freeTensors.splice(l, 1)[0];
                return p.sessionId = t, p;
              }
            Z("verbose", () => `[WebNN] MLContext.createTensor {dataType: ${n}, shape: ${r}}`);
            let d = await u.createTensor({ dataType: n, shape: r, dimensions: r, usage: o, writable: i, readable: s });
            return new Wt({ sessionId: t, context: u, tensor: d, dataType: n, shape: r, shouldConvertInt64toInt32: a });
          }
          releaseTensor(t) {
      ...
      var On, sd, Ht, fo = E(() => {
        ...
        mo();
        Ae();
        On = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), sd = (e, t) => {
          if (e === t)
            return true;
          ...
          async createMLContext(t) {
            ...
            let n = this.mlContextCache.findIndex((r) => sd(r.options, t));
            if (n !== -1)
          ...
          uploadTensor(t, n) {
            if (!ee().shouldTransferToMLTensor)
          ...
          registerMLConstant(t, n, r, o, i, s, a = false) {
            ...
            switch (i.dataType) {
              ...
              case "uint32":
                ...
                break;
              case "int64":
                a ? (c = Bn(new Uint8Array(l), false), i.dataType = "int32") : c = new BigInt64Array(l);
                break;
              case "uint64":
      ...
      var ho, Dn, Mn, ad, ud, go, Un, Rn, bo, _o = E(() => {
        "use strict";
        Ae();
        qt();
        ho = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), Dn = [], Mn = (e) => Math.ceil(Number(e) / 16) * 16, ad = (e) => {
        ...
        }, ud = 1, go = () => ud++, Un = async (e, t, n, r) => {
          let o = Mn(n), i = e.device.createBuffer({ size: o, usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ });
          try {
          ...
          constructor(t) {
            ...
            for (let [n] of ho)
              Dn.push(n), this.freeBuffers.set(n, []), this.freeUniformBuffers.set(n, []);
            this.sessionCount = 0;
          }
          upload(t, n) {
            let r = n.buffer, o = n.byteOffset, i = n.byteLength, s = Mn(i), a = this.storageCache.get(t);
            if (!a)
          ...
          memcpy(t, n) {
            ...
            let i = Mn(r.originalSize), s = this.backend.getCommandEncoder();
          ...
          create(t, n = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
            let r = ad(t), o, i = (n & GPUBufferUsage.STORAGE) === GPUBufferUsage.STORAGE, s = (n & GPUBufferUsage.UNIFORM) === GPUBufferUsage.UNIFORM;
            if (i || s) {
          ...
          async download(t, n) {
            ...
            await Un(this.backend, r.gpuData.buffer, r.originalSize, n);
          }
      ...
      var Ke, Ln, te, le, P, Q, Wn, je, xe, O, Ft, S, C, wo, Kt, Nn, $o, K = E(() => {
        "use strict";
        L();
        q();
        Ke = 64, Ln = (e, t) => {
  ...
  fn o2i_${e}(offset: u32) -> ${p.indices} {
    ...
    return indices;
          ...
          if (s >= 2)
            for (let k = s - 1; k >= 0; k--)
              v.push(`${O(y, k, s)} * (indices[${k}])`);
          let $ = s < 2 ? "" : `
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
  }`, T = (k) => (m.indicesToOffset = true, s < 2 ? k : `i2o_${e}(${k})`), I = (...k) => s === 0 ? "0u" : `${p.indices}(${k.map(f).join(",")})`, A = (k, U) => s < 2 ? `${k}` : `${O(k, U, s)}`, B = (k, U, ne) => s < 2 ? `${k}=${ne};` : `${O(k, U, s)}=${ne};`, M = {}, V = (k, U) => {
            m.broadcastedIndicesToOffset = true;
            let ne = `${U.name}broadcastedIndicesTo${e}Offset`;
            if (ne in M)
              return `${ne}(${k})`;
            let Re = [];
            for (let ae = s - 1; ae >= 0; ae--) {
              let ue = U.indicesGet("outputIndices", ae + U.rank - s);
              Re.push(`${A(y, ae)} * (${ue} % ${A(b, ae)})`);
            }
            return M[ne] = `fn ${ne}(outputIndices: ${U.type.indices}) -> u32 {
            ...
            if (p.storage === "vec2<u32>" && p.value === "i32")
              return `${e}[${k}]=vec2<u32>(u32(${U}), select(0u, 0xFFFFFFFFu, ${U} < 0));`;
            if (p.storage === "vec2<u32>" && p.value === "u32")
              return `${e}[${k}]=vec2<u32>(u32(${U}), 0u);`;
            if (p.storage === "u32" && p.value === "vec4<bool>")
              return `${e}[${k}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${U}));`;
  ...
  fn get_${e}ByIndices(indices: ${p.indices}) -> ${l} {
    return ${G(`i2o_${e}(indices)`)};
            ...
            let k = a.map((ne) => `d${ne}: u32`).join(", "), U = a.map((ne) => `d${ne}`).join(", ");
            return `
  fn get_${e}(${k}) -> ${l} {
    return get_${e}ByIndices(${I(U)});
            ...
            let U = k.map(f).join(",");
            return s === 0 ? G("0u") : s === 1 ? G(U[0]) : (m.get = true, m.getByIndices = true, m.indicesToOffset = true, `get_${e}(${U})`);
          }, j = (k) => s < 2 ? G(k) : (m.getByIndices = true, m.indicesToOffset = true, `get_${e}ByIndices(${k})`), W = s < 2 ? "" : `
  ...
  fn set_${e}(${k}, value: ${l}) {
    set_${e}ByIndices(${I(U)}, value);
          ...
          return { impl: () => {
            let k = [], U = false;
            return m.offsetToIndices && (k.push(_), U = true), m.indicesToOffset && (k.push($), U = true), m.broadcastedIndicesToOffset && (Object.values(M).forEach((ne) => k.push(ne)), U = true), m.set && (k.push(ie), U = true), m.setByIndices && (k.push(W), U = true), m.get && (k.push(D), U = true), m.getByIndices && (k.push(re), U = true), !i && U && k.unshift(`const ${b} = ${p.indices}(${n.join(",")});`, `const ${y} = ${p.indices}(${x.computeStrides(n).join(",")});`), k.join(`
`);
          }, type: p, offsetToIndices: w, indicesToOffset: T, broadcastedIndicesToOffset: V, indices: I, indicesGet: A, indicesSet: B, set: (...k) => {
            if (k.length !== s + 1)
              throw new Error(`indices length must be ${s}`);
            let U = k[s];
            if (typeof U != "string")
              throw new Error("value must be string");
            let ne = k.slice(0, s).map(f).join(",");
            return s === 0 ? z("0u", U) : s === 1 ? z(ne[0], U) : (m.set = true, m.setByIndices = true, m.indicesToOffset = true, `set_${e}(${ne}, ${U})`);
          }, setByOffset: z, setByIndices: (k, U) => s < 2 ? z(k, U) : (m.setByIndices = true, m.indicesToOffset = true, `set_${e}ByIndices(${k}, ${U});`), get: R, getByOffset: G, getByIndices: j, usage: r, name: e, strides: y, shape: b, rank: s };
        }, S = (e, t, n, r = 1) => Ft(e, t, n, "input", r), C = (e, t, n, r = 1) => Ft(e, t, n, "output", r), wo = (e, t, n) => Ft(e, t, n, "atomicOutput", 1), Kt = (e, t, n, r = 1) => Ft(e, t, n, "internal", r), Nn = class {
          constructor(t, n) {
...
`);
      ...
      var dd, vo, ld, cd, pd, md, ce, xo, So, De = E(() => {
        "use strict";
        L();
        q();
        oe();
        ...
        }, vo = (e, t) => t.length !== 0 ? t : [...new Array(e).keys()].reverse(), ld = (e, t) => x.sortBasedOnPerm(e, vo(e.length, t)), cd = (e, t, n, r) => {
    ...
    var a: ${n.type.indices};`;
          ...
          let n = e.dataType, r = e.dims.length, o = vo(r, t), i = ld(e.dims, o), s = e.dims, a = i, u = r < 2 || md(o, e.dims), d;
          if (u)
            return d = (h) => {
  ...
  ${h.mainStart()}
    ...
    output[global_idx] = input[global_idx];
          ...
          let { newShape: l, newPerm: c } = pd(e.dims, o), p = x.areEqual(c, [2, 3, 1]), f = x.areEqual(c, [3, 1, 2]);
          if (l.length === 2 || p || f) {
  ...
  ${h.mainStart()}
    ...
    ${y.setByOffset("global_idx", b.getByIndices("aIndices"))}
          ...
          dd(e.inputs, t.perm), e.compute(ce(e.inputs[0], t.perm));
        }, So = (e) => N({ perm: e.perm });
      });
      var fd, hd, gd, yd, bd, _d, wd, $d, vd, xd, ke, To, Io, Co, Ao, Eo, ko, Po, zo, Bo, Oo, Do = E(() => {
        "use strict";
        L();
        q();
        K();
        jt();
        De();
        fd = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate * candidate", logSumExp: "bestValue + exp(candidate)", l1: "bestValue + abs(candidate)", l2: "bestValue + candidate * candidate", logSum: "bestValue + candidate" }, hd = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate", logSumExp: "bestValue + candidate", l1: "bestValue + candidate", l2: "bestValue + candidate", logSum: "bestValue + candidate" }, gd = { max: "_A[offset]", min: "_A[offset]", mean: "0", sum: "0", prod: "1", sumSquare: "0", logSumExp: "0", l1: "0", l2: "0", logSum: "0" }, yd = { max: "bestValue", min: "bestValue", sum: "bestValue", prod: "bestValue", sumSquare: "bestValue", logSumExp: "log(bestValue)", l1: "bestValue", l2: "sqrt(bestValue)", logSum: "log(bestValue)" }, bd = (e, t) => {
          let n = [];
          for (let r = t - e; r < t; ++r)
            n.push(r);
          return n;
       ...
       `, m = (h) => `
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ...
          let o = e.inputs.length === 1 ? n : Gn(e.inputs, n), i = o.axes;
          i.length === 0 && !o.noopWithEmptyAxes && (i = e.inputs[0].dims.map((f, m) => m));
          let s = x.normalizeAxes(i, e.inputs[0].dims.length), a = s, u = e.inputs[0], d = vd(a, e.inputs[0].dims.length);
          d.length > 0 && (u = e.compute(ce(e.inputs[0], d), { inputs: [0], outputs: [-1] })[0], a = bd(a.length, u.dims.length));
          let [l, c] = _d(u.dims, a), p = l;
          o.keepDims && (p = wd(l, s)), e.compute(xd(t, o.cacheKey, [u], r, e.inputs[0].dataType, p, c), { inputs: [u] });
        }, To = (e, t) => {
      ...
      var Pe, Sd, Zt, Gn, ze, Td, Id, Cd, Ad, Ed, kd, Pd, zd, Bd, Od, Be, Mo, Ro, Uo, Vo, No, Lo, Wo, Go, Ho, qo, jt = E(() => {
        "use strict";
        L();
        q();
        oe();
        ...
        }, Sd = (e) => ["", "", `var value = ${e.getByIndices("input_indices")};`, ""], Zt = (e, t, n, r, o, i, s = false, a = false) => {
...
`)}
          ...
          let o = e.inputs, i = o.length === 1 ? n : Gn(o, n);
          e.compute(Zt(t, { hint: i.cacheKey, inputDependencies: ["rank"] }, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? Sd : r, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
        }, Td = (e, t) => {
          Pe(e.inputs), ze(e, "ReduceLogSum", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += ${r.getByIndices("input_indices")};`, "value = log(value);"]);
        }, Id = (e, t) => {
          Pe(e.inputs), ze(e, "ReduceL1", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += abs(${r.getByIndices("input_indices")});`, ""]);
        }, Cd = (e, t) => {
          Pe(e.inputs), ze(e, "ReduceL2", t, (r, o) => [`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`, "", `t = ${r.getByIndices("input_indices")}; value += (t * t);`, "value = sqrt(value);"]);
        }, Ad = (e, t) => {
          Pe(e.inputs), ze(e, "ReduceLogSumExp", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += exp(${r.getByIndices("input_indices")});`, "value = log(value);"]);
        }, Ed = (e, t) => {
          Pe(e.inputs), ze(e, "ReduceMax", t, (r, o, i) => {
            let s = [];
...
`)}`, `var value = ${r.getByIndices("input_indices")};`, `value = max(value, ${r.getByIndices("input_indices")});`, ""];
          ...
          Pe(e.inputs), ze(e, "ReduceMean", t, (r, o, i) => {
            let s = 1;
            for (let a = 0; a < r.rank; a++)
          ...
          Pe(e.inputs), ze(e, "ReduceMin", t, (r, o, i) => {
            let s = [];
            for (let a = 0; a < r.rank; a++)
...
`)}`, `var value = ${r.getByIndices("input_indices")};`, `value = min(value, ${r.getByIndices("input_indices")});`, ""];
          ...
          Pe(e.inputs), ze(e, "ReduceProd", t, (r, o) => [`var value = ${o.type.storage}(1);`, "", `value *= ${r.getByIndices("input_indices")};`, ""]);
        }, Bd = (e, t) => {
          Pe(e.inputs), ze(e, "ReduceSum", t, (r, o) => [`var value = ${o.type.storage}(0);`, "", `value += ${r.getByIndices("input_indices")};`, ""]);
        }, Od = (e, t) => {
          Pe(e.inputs), ze(e, "ReduceSumSquare", t, (r, o) => [`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`, "", `t = ${r.getByIndices("input_indices")}; value += t * t;`, ""]);
        }, Be = (e, t, n) => {
          if (t.length === 0)
            return n;
          let r = 1, o = 1;
          ...
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? kd(e, t) : To(e, t);
        }, Ro = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Id(e, t) : Io(e, t);
        }, Uo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Cd(e, t) : Co(e, t);
        }, Vo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ad(e, t) : Ao(e, t);
        }, No = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ed(e, t) : Eo(e, t);
        }, Lo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Pd(e, t) : ko(e, t);
        }, Wo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? zd(e, t) : Po(e, t);
        }, Go = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Bd(e, t) : zo(e, t);
        }, Ho = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Od(e, t) : Bo(e, t);
        }, qo = (e, t) => {
          Be(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Td(e, t) : Oo(e, t);
        };
      });
      var Fo, Ko, jo, Hn, Zo = E(() => {
        "use strict";
        L();
        oe();
        jt();
...
var best_index : i32 = 0;`, `if (${r.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? "<=" : "<"} value) {
         ...
         best_index = i32(last_index);
          ...
          e.compute(Zt("ArgMin", { hint: t.cacheKey, inputDependencies: ["rank"] }, [e.inputs[0]], n, [t.axis], 7, t.keepDims), { inputs: [0] });
        }, jo = (e, t) => {
          Fo(e.inputs);
          let n = (r, o, i) => {
            let s = [];
...
var best_index : i32 = 0;`, `if (${r.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? ">=" : ">"} value) {
         ...
         best_index = i32(last_index);
          ...
          e.compute(Zt("argMax", { hint: t.cacheKey, inputDependencies: ["rank"] }, [e.inputs[0]], n, [t.axis], 7, t.keepDims), { inputs: [0] });
        }, Hn = (e) => N(e);
      });
      var Dd, qn, Md, Rd, Ud, et, Vd, Qo, Qt = E(() => {
        "use strict";
        L();
        q();
        qt();
    ...
    `, Md = (e, t, n, r, o, i, s, a) => {
          let u = Q(s ? 1 : i), d = 64, l = i / u;
          l < d && (d = 32);
          let c = Math.ceil(i / u / d), p = [{ type: 12, data: t }, { type: 12, data: n }, { type: 12, data: r }, { type: 12, data: o }, { type: 12, data: l }, { type: 12, data: c }], f = te(e.dataType, u), m = le(1, u), h = ["type"];
    ...
    if (sum == 0) {
      ...
      ${s ? `
        for (var total_seq_id: u32 = seq_causal_length; total_seq_id + local_offset < uniforms.total_sequence_length; total_seq_id++) {
          ...
          let I = (A) => {
            let B = S("q", t.dataType, t.dims, b), M = S("key", n.dataType, n.dims, b), V = [B, M];
            if (v) {
              let W = S("past_key", r.dataType, r.dims, b);
              V.push(W);
            }
            o && V.push(S("attention_bias", o.dataType, o.dims));
            let z = a ? S("seq_lens", a.dataType, a.dims) : void 0;
            z && V.push(z);
            let G = u ? S("total_sequence_length_input", u.dataType, u.dims) : void 0;
            G && V.push(G);
            let re = C("output", t.dataType, l), D = [re];
            c && D.push(C("present_key", t.dataType, f, b));
            let R = le(1, b), j = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "alpha", type: "f32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
            return `
  const TILE_SIZE = ${g}u;
  ...
  ${A.mainStart([g, g, 1])}
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
        ...
        output[outputIdx] = ${re.type.value} (sum * uniforms.alpha) + ${o ? "attention_bias[outputIdx]" : "0.0"};
        ...
        }, Ud = (e, t, n, r, o, i, s = void 0, a = void 0) => {
          ...
          let v = ($) => {
            ...
            let B = s ? S("seq_lens", s.dataType, s.dims) : void 0;
            s && A.push(B);
            ...
            let G = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "v_hidden_size", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
            return `
  const TILE_SIZE = ${h}u;
  ...
  ${$.mainStart([h, h, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
        ...
        }, et = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
          ...
          let y = e.compute(Rd(p, t, n, s, h, d, f, l, c), { inputs: b, outputs: p > 1 ? [-1, 1] : [-1] })[0];
          e.compute(Md(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c), { inputs: l && c ? [y, l, c] : [y], outputs: [] });
          let g = [y, r];
          p > 1 && a && x.size(a.dims) > 0 && g.push(a), l && g.push(l), c && g.push(c), e.compute(Ud(p, y, r, a, d, f, l, c), { inputs: g, outputs: p > 1 ? [0, 2] : [0] });
        }, Vd = (e, t) => {
  ...
  ${c.mainStart([s, s, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      output_v[outputIdx] = valueV;
          ...
          let n = Dd(e.inputs, t), [r, o, i] = Vd(e, n);
          return et(e, r, o, i, e.inputs[4], void 0, void 0, void 0, e.inputs[5], n);
        };
      });
      var Nd, Ld, Wd, Xo, Yo = E(() => {
        "use strict";
        $e();
        L();
        q();
        ...
        Nd = (e, t) => {
          ...
          let { epsilon: n, spatial: r, format: o } = t, i = e[0].dims, s = r ? Q(i[i.length - 1]) : 1, a = o === "NHWC" && i.length > 1 ? s : 1, u = x.size(i) / s, d = r, l = d ? i.length : i, c = S("x", e[0].dataType, e[0].dims, s), p = S("scale", e[1].dataType, e[1].dims, a), f = S("bias", e[2].dataType, e[2].dims, a), m = S("inputMean", e[3].dataType, e[3].dims, a), h = S("inputVar", e[4].dataType, e[4].dims, a), b = C("y", e[0].dataType, l, s), y = () => {
            let _ = "";
            if (r)
  ...
  ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${b.setByOffset("global_idx", "value")}
          ...
          let { inputs: n, outputCount: r } = e, o = Wd({ ...t, outputCount: r });
          if (J.webgpu.validateInputContent && Nd(n, o), t.trainingMode)
  ...
  ${l.mainStart()}
    ...
    ${u.setByOffset("global_idx", "value")}
          ...
          Gd(e.inputs), e.compute(Hd(e.inputs));
        };
      });
      var qd, Y, ti, ni, ri, oi, ii, si, ai, ui, di, Fd, li, ci, pi, mi, pt, fi, Xt, hi, gi, yi, bi, _i, wi, $i, vi, xi, Si, Ti, Ii, Ci, Ai, Ei, ki, Pi, zi, Fn, Kn, Bi, Oi, Di, Kd, jd, Mi, Yt = E(() => {
        "use strict";
        L();
        q();
        oe();
  ...
  ${e.mainStart()}
    ...
    ${l.setByOffset("global_idx", u)}
          ...
          return s && u.push(...s), { name: t, shaderCache: { hint: o, inputDependencies: ["type"] }, getShaderSource: (d) => qd(d, x.size(e.dims), e.dataType, i, n, r, a), getRunData: (d) => ({ outputs: [{ dims: e.dims, dataType: i }], dispatchGroup: { x: Math.ceil(x.size(d[0].dims) / 64 / 4) }, programUniforms: u }) };
        }, ti = (e) => {
          ...
          let n = t || Fd(e.inputs), r = le(e.inputs[0].dataType);
...
fn erf_vf32(v: vec4<${e}>) -> vec4<${e}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
          ...
          e.compute(Y(e.inputs[0], "Erf", (n) => `erf_vf32(${n})`, Xt(t)));
        }, gi = (e) => {
          ...
          let t = le(e.inputs[0].dataType);
          e.compute(Y(e.inputs[0], "Gelu", (n) => `0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`, Xt(t)));
        }, _i = (e, t) => {
          let n = le(e.inputs[0].dataType);
        ...
        }, Pi = (e) => `sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`, zi = (e) => {
          e.compute(Y(e.inputs[0], "Tanh", Pi));
        }, Fn = (e = "f32") => `
...
`, Kn = (e) => `(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`, Bi = (e) => {
          let t = le(e.inputs[0].dataType);
          e.compute(Y(e.inputs[0], "FastGelu", Kn, Fn(t), void 0, e.inputs[0].dataType));
        }, Oi = (e, t) => {
          let n = le(e.inputs[0].dataType);
...
`, jd = (e) => `quick_gelu_impl(${e})`, Mi = (e, t) => {
          let n = le(e.inputs[0].dataType);
          e.compute(Y(e.inputs[0], "QuickGelu", jd, Kd(n, t.alpha), t.cacheKey, e.inputs[0].dataType));
        };
      });
      var Zd, Qd, Ui, Vi = E(() => {
        "use strict";
        ...
        Zd = (e) => {
          ...
          t[2] = t[2] / 2;
          let n = S("input", e[0].dataType, e[0].dims, 4), r = S("bias", e[0].dataType, [e[0].dims[2]], 4), o = C("output", e[0].dataType, t, 4), i = x.size(t) / 4, s = te(e[0].dataType);
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
          ...
          Zd(e.inputs), e.compute(Qd(e.inputs));
        };
      });
      var Xd, Yd, Oe, Ni, Li, Wi, Gi, Hi, qi, Fi, Ki, ji, Zi, Qi = E(() => {
        "use strict";
        L();
        q();
        K();
        Xd = (e, t, n, r, o, i, s, a, u, d, l, c) => {
          let p, f;
        ...
        ${y}
          ...
          if (d) {
            ...
            p = true;
          return m.push(p), { name: e, shaderCache: { hint: t + m.map((h) => h.toString()).join("_"), inputDependencies: ["rank", "rank"] }, getShaderSource: (h) => Xd(h, a, u, l, p, d, f, o, n.dataType, r.dataType, s, i), getRunData: () => ({ outputs: [{ dims: l, dataType: s }], dispatchGroup: { x: Math.ceil(c / 64 / 4) }, programUniforms: [{ type: 12, data: Math.ceil(x.size(l) / 4) }, ...P(a, u, l)] }) };
        }, Oe = (e, t, n, r, o, i) => {
          e.compute(Yd(t, o ?? "", e.inputs[0], e.inputs[1], n, r, i));
        }, Ni = (e) => {
          Oe(e, "Add", (t, n) => `${t}+${n}`);
        }, Li = (e) => {
          Oe(e, "Div", (t, n) => `${t}/${n}`);
        }, Wi = (e) => {
          Oe(e, "Equal", { scalar: (t, n) => `u32(${t}==${n})`, vector: (t, n) => `vec4<u32>(${t}==${n})` }, void 0, void 0, 9);
        }, Gi = (e) => {
          Oe(e, "Mul", (t, n) => `${t}*${n}`);
        }, Hi = (e) => {
          let t = S("input", e.inputs[0].dataType, e.inputs[0].dims).type.value;
          Oe(e, "Pow", { scalar: (r, o) => `pow_custom(${r},${o})`, vector: (r, o) => `pow_vector_custom(${r},${o})` }, `
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `);
          ...
          Oe(e, "Greater", { scalar: (t, n) => `u32(${t}>${n})`, vector: (t, n) => `vec4<u32>(${t}>${n})` }, void 0, void 0, 9);
        }, Ki = (e) => {
          Oe(e, "Less", { scalar: (t, n) => `u32(${t}<${n})`, vector: (t, n) => `vec4<u32>(${t}<${n})` }, void 0, void 0, 9);
        }, ji = (e) => {
          Oe(e, "GreaterOrEqual", { scalar: (t, n) => `u32(${t}>=${n})`, vector: (t, n) => `vec4<u32>(${t}>=${n})` }, void 0, void 0, 9);
        }, Zi = (e) => {
          Oe(e, "LessOrEqual", { scalar: (t, n) => `u32(${t}<=${n})`, vector: (t, n) => `vec4<u32>(${t}<=${n})` }, void 0, void 0, 9);
        };
      });
      var el, tl, nl, rl, Xi, Yi, Ji = E(() => {
        "use strict";
        L();
        q();
        oe();
...
`);
  ...
  ${h.mainStart()}
    ...
    ${nl(s, c)}
          ...
          e.compute(rl(s, o, i, n[0].dataType), { inputs: s });
        }, Yi = (e) => N({ axis: e.axis });
      });
      var Se, Te, Ie, Jt, Le = E(() => {
        "use strict";
        L();
        q();
        Se = (e, t, n = "f32") => {
...
`;
        }, tn = (e, t, n, r, o = false, i) => {
          let s = e[0].dims, a = e[1].dims, u = s[s.length - 2], d = a[a.length - 1], l = s[s.length - 1], c = Q(d), p = Q(l), f = Q(u), m = x.size(n) / c / f, h = e.length > 2, b = r ? r.slice(0, -2) : n.slice(0, -2), g = [x.size(b), u, d], _ = [{ type: 12, data: m }, { type: 12, data: u }, { type: 12, data: d }, { type: 12, data: l }];
          Te(t, _), _.push(...P(b, s, a)), h && _.push(...P(e[2].dims)), _.push(...P(g));
          let w = (v) => {
            let $ = Kt("batch_dims", e[0].dataType, b.length), T = S("a", e[0].dataType, s.length, p), I = S("b", e[1].dataType, a.length, c), A = C("output", e[0].dataType, g.length, c), B = te(A.type.tensor), M = Se(t, A.type.value, B), V = [T, I], z = "";
            if (h) {
              let D = o ? c : 1;
              V.push(S("bias", e[2].dataType, e[2].dims.length, D)), z = `${o ? `value += bias[col / ${D}];` : `value += ${A.type.value}(bias[row + i]);`}`;
            }
            let G = [{ name: "output_size", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }];
            Ie(t, G);
            let re = () => {
              let D = `var a_data: ${T.type.value};`;
              for (let R = 0; R < p; R++)
                D += `
              let b_data${R} = b[(b_offset + (k + ${R}) * uniforms.N + col) / ${c}];`;
              for (let R = 0; R < f; R++) {
                D += `a_data = a[(a_offset + (row + ${R}) * uniforms.K + k) / ${p}];`;
                for (let j = 0; j < p; j++)
                  D += `
...
`;
  ...
  `;
      ...
      var ol, il, jn, rs, sl, Zn, al, ft, rn = E(() => {
        "use strict";
        L();
        q();
        K();
        ...
        }`, jn = (e, t, n = "f32", r, o = false, i = 32, s = false, a = 32) => {
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, sl = (e) => e ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", Zn = (e, t, n = "f32", r, o = false, i = 32, s = false, a = 32, u = false) => {
...
`;
          ...
          let [i, s, a, u] = r, d = te(r[0].type.tensor);
          return `
    ...
    `;
          ...
          Te(t, A), A.push(...P(l, w, $));
          let B = ["rank", "rank"], M = e.length > 2;
          M && (A.push(...P(e[2].dims)), B.push("rank")), A.push(...P(I));
          let V = (z) => {
            let G = l.length, re = Kt("batchDims", e[0].dataType, G, 1), D = te(e[0].dataType), R = S("a", e[0].dataType, v, _), j = S("b", e[1].dataType, T, _), W = C("result", e[0].dataType, I.length, _), ie = [R, j];
            if (M) {
              let U = o ? _ : 1;
              ie.push(S("bias", e[2].dataType, e[2].dims.length, U));
            }
            let me = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }];
            Ie(t, me);
            let se = te(W.type.tensor), H = Se(t, W.type.value, se), k = al(_, M, H, [re, R, j, W], o);
            return `
  ...
  ${h ? jn(b, y, D, re) : Zn(b, y, D, re)}
          ...
          return { name: "MatMul", shaderCache: { hint: `${b};${t.activation};${h};${o}`, inputDependencies: B }, getRunData: () => ({ outputs: [{ dims: i ? i(n) : n, dataType: e[0].dataType }], dispatchGroup: { x: g[0], y: g[1], z: g[2] }, programUniforms: A }), getShaderSource: V };
        };
      });
      var ul, os, is = E(() => {
        "use strict";
        ...
        ns();
        rn();
        ul = (e, t, n, r, o = false, i, s = 4, a = 4, u = 4, d = "f32") => {
          let l = (B) => {
            switch (B) {
              case 1:
              ...
              default:
                throw new Error(`innerElementSize ${B} is not supported.`);
            }
          }, c = (B) => {
            switch (B) {
              case 1:
    ...
    return ${de(a, d)}(0.0);`, v = de(u, d), $ = e ? de(s, d) : de(a, d), T = e ? de(a, d) : de(s, d), I = Se(i, v, d);
          return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
          ...
          let v = h ? d && l % 4 !== 0 ? 3 : 4 : 1, $ = g[1] * _[1], T = g[0] * _[0], I = Math.max(g[0] * v, g[1]), A = r % $ === 0, B = o % T === 0, M = i % I === 0, V = h ? [v, 4, 4] : [1, 1, 1], z = [{ type: 6, data: r }, { type: 6, data: o }, { type: 6, data: i }, { type: 6, data: [t.pads[0], t.pads[1]] }, { type: 6, data: t.strides }, { type: 6, data: t.dilations }];
          Te(t, z), z.push(...P(e[0].dims, e[1].dims));
          let G = ["rank", "rank"];
          s && (z.push(...P(e[2].dims)), G.push("rank")), z.push(...P(n));
          let re = (D) => {
            let R = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }, { name: "pad", type: "i32", length: 2 }, { name: "stride", type: "i32", length: 2 }, { name: "dilation", type: "i32", length: 2 }];
            Ie(t, R);
            let j = h ? 4 : 1, W = te(e[0].dataType), ie = `
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${W}>` : W}) {
      ...
      }`, me = S("x", e[0].dataType, e[0].dims.length, v === 3 ? 1 : v), se = S("w", e[1].dataType, e[1].dims.length, j), H = [me, se], k = C("result", e[0].dataType, n.length, j);
            if (s) {
              let U = S("bias", e[2].dataType, e[2].dims.length, j);
              H.push(U), ie += `
        ...
        ${h ? jn(_, g, W, void 0, !d, I) : Zn(_, g, W, void 0, !d, I, false, void 0, a)}`;
          };
          return { name: "Conv2DMatMul", shaderCache: { hint: `${t.cacheKey};${v};${h};${A};${B};${M};${$};${T};${I}`, inputDependencies: G }, getRunData: () => ({ outputs: [{ dims: u ? u(n) : n, dataType: e[0].dataType }], dispatchGroup: { x: w[0], y: w[1], z: w[2] }, programUniforms: z }), getShaderSource: re };
        };
      });
      var dl, ss, on, ll, as, cl, us, ds, ls = E(() => {
        "use strict";
        L();
        Ae();
        q();
        ...
        dl = (e) => {
          ...
          for (let n = 0; n < e.length; n++)
            t *= e[n];
          return t;
        }, ss = (e) => typeof e == "number" ? [e, e, e] : e, on = (e, t) => t <= 1 ? e : e + (e - 1) * (t - 1), ll = (e, t, n, r = 1) => {
          let o = on(t, r);
          return Math.floor((e[0] * (n - 1) - n + o) / 2);
        }, as = (e, t, n, r, o) => {
          o == null && (o = ll(e, t[0], r[0]));
          let i = [0, 0, 0, n];
          for (let s = 0; s < 3; s++)
          ...
          if (e === "VALID" && (e = 0), typeof e == "number") {
            ...
            let m = as([t, n, r, 1], [a, u, d], 1, [o, i, s], e);
            c = m[0], p = m[1], f = m[2];
            ...
            let m = as([t, n, r, 1], [a, u, d], 1, [o, i, s], e[0]);
            c = m[0], p = m[1], f = m[2];
        ...
        }, us = (e, t, n, r, o, i = false, s = "channelsLast") => {
          let a, u, d, l, c;
          if (s === "channelsLast")
            [a, u, d, l, c] = e;
          ...
          Te(t, m), m.push(...P(e[0].dims, e[1].dims));
          ...
          let y = (g) => {
            ...
            Ie(t, _);
            let w = u ? 4 : 1, v = te(e[0].dataType), $ = S("x", e[0].dataType, e[0].dims.length, p === 3 ? 1 : p), T = S("W", e[1].dataType, e[1].dims.length, w), I = [$, T], A = C("result", e[0].dataType, n.length, w), B = "";
            if (b) {
      ...
      var cs, ps, ms = E(() => {
        ...
        Le();
        cs = (e, t, n, r) => {
          let o = e.length > 2, i = o ? "value += b[output_channel];" : "", s = e[0].dims, a = e[1].dims, u = t.format === "NHWC", d = u ? n[3] : n[1], l = d / t.group, c = u && l >= 4 ? Q(d) : 1, p = x.size(n) / c, f = [{ type: 12, data: p }, { type: 12, data: t.dilations }, { type: 12, data: [t.strides[0], t.strides[1]] }, { type: 12, data: [t.pads[0], t.pads[1]] }, { type: 12, data: l }];
          Te(t, f), f.push(...P(s, [a[0], a[1], a[2], a[3] / c]));
          let m = o ? ["rank", "rank", "rank"] : ["rank", "rank"];
          f.push(...P([n[0], n[1], n[2], n[3] / c]));
          let h = (b) => {
            let y = C("output", e[0].dataType, n.length, c), g = te(y.type.tensor), _ = Se(t, y.type.value, g), w = S("x", e[0].dataType, s.length), v = S("w", e[1].dataType, a.length, c), $ = [w, v];
  ...
  ${b.mainStart()}
    ...
    ${y.setByOffset("global_idx", "value")}
          ...
          let o = e.length > 2, i = Q(n[3]), s = Q(n[2]), a = x.size(n) / i / s, u = [e[0].dims[0], e[0].dims[1], e[0].dims[2], e[0].dims[3] / i], d = [e[1].dims[0], e[1].dims[1], e[1].dims[2], e[1].dims[3] / i], l = [n[0], n[1], n[2], n[3] / i], c = [{ type: 12, data: a }, { type: 6, data: [t.strides[0], t.strides[1]] }, { type: 6, data: [t.pads[0], t.pads[1]] }];
          Te(t, c), c.push(...P(u, d, l));
          let p = (s - 1) * t.strides[1] + d[1], f = (m) => {
            let h = C("output", e[0].dataType, l.length, i), b = te(h.type.tensor), y = Se(t, h.type.value, b), g = S("x", e[0].dataType, u.length, i), _ = S("w", e[1].dataType, d.length, i), w = [g, _];
  ...
  ${m.mainStart()}
    ...
    for (var i = 0u; i < ${s}u; i++) {
      ...
      var pl, Qn, ml, Xn, Yn, fs, fl, hl, Jn, hs = E(() => {
        "use strict";
        q();
        is();
        ls();
        ...
        pl = (e, t, n, r, o, i) => {
          ...
          let r = e.pads.slice();
          Fe.adjustPadsBasedOnAutoPad(t[0].dims, e.strides, e.dilations, n, r, e.format === "NHWC", e.autoPad);
          ...
          let o = n.format === "NHWC", i = pl(t[0].dims, t[1].dims, n.dilations, n.pads, n.strides, o);
          if (n.group !== 1) {
            let $ = [t[0]];
            if (o) {
              let I = e.kernelCustomData.wT ?? e.compute(ce(t[1], Qn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
              n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = I), $.push(I);
            } else
              $.push(t[1]);
            t.length === 3 && $.push(t[2]), !e.adapterInfo.isArchitecture("ampere") && o && t[1].dims[0] === n.group && t[1].dims[1] === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 ? e.compute(ps($, n, i, r), { inputs: $ }) : e.compute(cs($, n, i, r), { inputs: $ });
            return;
          }
          ...
          if (h || l === 1 && c === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 && n.strides[0] === 1 && n.strides[1] === 1 && n.pads[0] === 0 && n.pads[1] === 0) {
            let $ = i[0], T, I, A, B = [];
            if (o) {
              let z = e.kernelCustomData.wT ?? e.compute(ce(t[1], Qn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
              if (n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = z), h) {
                let G = a * u * d;
                T = t[0].reshape([1, $, G]), I = z.reshape([1, G, m]), A = [1, $, m];
              } else
                T = t[0].reshape([$, a * u, d]), I = z.reshape([1, d, m]), A = [$, p * f, m];
              B.push(T), B.push(I);
            } else
              T = t[0].reshape([$, d, a * u]), I = t[1].reshape([1, m, d]), A = [$, m, p * f], B.push(I), B.push(T);
            s && B.push(t[2]);
            let M = A[2], V = B[0].dims[B[0].dims.length - 1];
            M < 8 && V < 8 ? e.compute(tn(B, n, i, A, o, r), { inputs: B }) : e.compute(ft(B, n, i, A, o, r), { inputs: B });
            return;
          }
          let b = true, y = e.kernelCustomData.wT ?? e.compute(ce(t[1], Qn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
          n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = y);
          let g = [t[0], y];
          s && g.push(t[2]);
          let _ = o ? p * f : m, w = o ? m : p * f, v = l * c * d;
          e.compute(os(g, n, i, _, w, v, s, b, r), { inputs: g });
        }, fl = (e, t) => {
          ...
          let o = [0, t.pads[0], 0, t.pads[1]], i = [1].concat(t.strides), s = [1].concat(t.dilations), a = [1].concat(t.kernelShape), u = Xn({ ...t, pads: o, strides: i, dilations: s, kernelShape: a }, r);
          fs(e, r, u, (d) => n ? [d[0], d[2], d[3]] : [d[0], d[1], d[3]]);
        }, hl = (e, t, n) => {
          let r = n.format === "NHWC" ? "channelsLast" : "channelsFirst", o = Xn(n, t), i = n.autoPad === "NOTSET" ? n.pads : n.autoPad, s = us(t[0].dims, t[1].dims, n.strides, n.dilations, i, false, r);
          e.compute(ds(t, o, s.outShape, [s.filterDepth, s.filterHeight, s.filterWidth], [s.padInfo.front, s.padInfo.top, s.padInfo.left], r));
        }, Jn = (e, t) => {
          if (ml(e.inputs, t), e.inputs[0].dims.length === 3)
            fl(e, t);
      ...
      var gs, ys = E(() => {
        ...
        K();
        gs = (e, t, n) => {
          let r = e.length > 2, o = t.outputShape, i = t.format === "NHWC", s = t.group, a = e[1].dims, u = a[2] / s, d = a[3], l = i ? Q(u) : 1, c = i && d === 1 && u >= 4, p = c ? Math.floor(u / 4) * 4 : Math.floor(u / l) * l, f = u - p, m = i ? Q(d) : 1, h = i ? d === 1 ? l : m : 1, b = x.size(o) / m, y = [Math.ceil(b / 64), 1, 1];
          ...
          let A = (B) => {
            let M = [{ name: "output_size", type: "u32" }, { name: "strides", type: "u32", length: _.length }, { name: "filter_dims", type: "u32", length: w.length }, { name: "dilations", type: "u32", length: w.length }, { name: "effective_filter_dims", type: "u32", length: $.length }, { name: "pads", type: "i32", length: T.length }, { name: "input_channels_per_group_int", type: "u32" }, { name: "input_channels_per_group", type: "u32" }, { name: "output_channels_per_group", type: "u32" }], V = te(e[0].dataType), z = i ? 1 : 2, G = i ? 2 : 3, re = i ? 3 : 1, D = S("W", e[1].dataType, e[1].dims.length, h), R = S("Dy", e[0].dataType, e[0].dims.length, l), j = [R, D];
            r && j.push(S("bias", e[2].dataType, [o[re]].length, m));
            let W = C("result", e[0].dataType, o.length, m), ie = () => {
              let H = "";
              if (c)
                l === 4 ? H += `
          ...
          dotProd = dotProd + xValue * wValue;`;
            ...
            dotProd = dotProd + xValue[${k}] * wValue${k};`;
              ...
              if (l === 1) {
                ...
                for (let k = 0; k < f; k++)
                  H += `
            + ${R.getByOffset(`x_offset + ${k}`)} * ${D.getByOffset(`w_offset + ${k}`)}`;
                H += ";";
              } else if (l === 2) {
                if (f !== 2)
    ...
    ${se}}`;
      ...
      var gl, yl, bl, bs, _s, _l, ws, wl, $s, vs = E(() => {
        "use strict";
        ys();
        Le();
        De();
        gl = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i, yl = (e, t, n, r, o) => {
          ...
          for (let m = 0, h = e.length - l - (a ? 1 : 0); m < l; ++m, ++h) {
            let b = e[h], y = c ? b * s[m] : d[m], g = gl(b, s[m], i[m], t[h], n[m], y);
            yl(g, r, i, m, m + l), c && d.push(s[m] * (b - 1) + u[m] + (t[h] - 1) * n[m] + 1 - i[m] - i[m + l]);
          }
          ...
          let i = [t[0], o];
          t.length === 3 && i.push(t[2]), e.compute(gs(i, n, r), { inputs: i });
        }, wl = (e, t) => {
          let n = t.format === "NHWC", r = [e.inputs[0].reshape(n ? [e.inputs[0].dims[0], 1, e.inputs[0].dims[1], e.inputs[0].dims[2]] : [e.inputs[0].dims[0], e.inputs[0].dims[1], 1, e.inputs[0].dims[2]]), e.inputs[1].reshape([e.inputs[1].dims[0], e.inputs[1].dims[1], 1, e.inputs[1].dims[2]])];
          e.inputs.length === 3 && r.push(e.inputs[2]);
          let o = t.kernelShape;
          ...
          u = [0].concat(u);
          let d = bs({ ...t, pads: a, strides: s, dilations: i, kernelShape: o, outputPadding: u }, r);
          ws(e, r, d, (l) => n ? [l[0], l[2], l[3]] : [l[0], l[1], l[3]]);
        }, $s = (e, t) => {
          if (_l(e.inputs, t), e.inputs[0].dims.length === 3)
            wl(e, t);
          else {
            let n = bs(t, e.inputs);
            ws(e, e.inputs, n);
...
`);
  ...
  ${y.mainStart()}
    ...
    ${h.setByOffset("global_idx", m.getByIndices("aIndices"))}
          ...
          vl(e.inputs), e.compute(Sl(e.inputs[0], t));
        }, Cs = (e) => N({ blocksize: e.blocksize, mode: e.mode, format: e.format });
      });
      var er, sn, Es, Tl, Il, tr, nr, ks, Cl, Ps, zs, Bs = E(() => {
        "use strict";
        L();
        q();
        oe();
        K();
        er = "[a-zA-Z]|\\.\\.\\.", sn = "(" + er + ")+", Es = "^" + sn + "$", Tl = "(" + sn + ",)*" + sn, Il = "^" + Tl + "$", tr = class {
          constructor(t = -1) {
          ...
          processTerm(t, n, r, o = -1) {
            ...
            if (!t.match(RegExp(Es)) && !n && t !== "")
              throw new Error("Invalid LHS term");
            let d = t.match(RegExp(er, "g")), l = new tr(o);
                ...
                n.lhs.forEach((T, I) => {
                  if (v.inputIndices.includes(I)) {
                    ...
                    if (A === void 0)
                      throw new Error("Invalid symbol error");
                    A.forEach((B) => {
                      h.push(`${i[I].indicesSet(`input${I}Indices`, B, `${$}`)}`);
...
`)};
          ...
          let n = new nr(e.inputs, t.equation), r = n.outputDims, o = e.inputs.map((i, s) => i.dims);
          e.compute(Cl(o, e.inputs[0].dataType, n, r));
        }, zs = (e) => {
          let t = e.equation.replace(/\s+/g, "");
          return N({ equation: t });
        };
      });
      var Al, Os, El, kl, Ds, Ms = E(() => {
        "use strict";
        L();
        q();
        K();
        Al = (e) => {
          ...
          return r;
        }, El = (e, t) => e.length > t.length ? Os(e, t) : Os(t, e), kl = (e) => {
          let t = e[0].dims, n = Array.from(e[1].getBigInt64Array(), Number), r = El(t, n), o = e[0].dataType, i = o === 9 || x.size(t) === 1, s = o === 9 || t.length > 0 && t[t.length - 1] % 4 === 0 ? 4 : 1, a = i || r.length > 0 && r[r.length - 1] % 4 === 0 ? 4 : 1, u = Math.ceil(x.size(r) / a), d = (c) => {
    ...
    ${m}`;
          ...
          Al(e.inputs), e.compute(kl(e.inputs), { inputs: [0] });
        };
      });
      var Pl, Rs, Us = E(() => {
        "use strict";
    ...
    ${s.mainStart(Ke)}
      ...
      ${d.setByOffset("global_idx", Kn("x_in"))}
          ...
          return { name: "FastGeluWithBias", shaderCache: { hint: `${o}`, inputDependencies: ["type", "type"] }, getShaderSource: i, getRunData: (s) => ({ outputs: [{ dims: s[0].dims, dataType: s[0].dataType }], programUniforms: [{ type: 12, data: Math.ceil(n / 4) }, { type: 12, data: r }], dispatchGroup: { x: Math.ceil(n / Ke / 4) } }) };
        }, Rs = (e) => {
          e.inputs.length < 2 || x.size(e.inputs[1].dims) === 0 ? Bi(e) : e.compute(Pl(e.inputs));
        };
      });
      var zl, Bl, Vs, Ns, Ls = E(() => {
        "use strict";
        L();
        q();
        oe();
      ...
      ${p.mainStart()}
        ...
        }, Vs = (e) => N({ axis: e.axis }), Ns = (e, t) => {
          let n = e.inputs;
          zl(n), e.compute(Bl(e.inputs, t));
        };
      });
      var Ol, Ws, Gs, Hs = E(() => {
        "use strict";
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
          ...
          let m = Ol(e, n[1], p, t.batchDims, r, a, c, l, s), h = t.batchDims + s;
          if (h > r.length)
        ...
        }, Gs = (e) => ({ batchDims: e.batch_dims, cacheKey: "" });
      });
      var Dl, Ml, qs, Fs, Ks = E(() => {
        "use strict";
        L();
        q();
        oe();
        ...
        ${_.setByOffset("global_idx", "dequantized_data")};
          ...
          let n = e.inputs;
          Dl(n, t), e.compute(Ml(e.inputs, t));
        }, Fs = (e) => N({ blockSize: e.blockSize, gatherAxis: e.gatherAxis, quantizeAxis: e.quantizeAxis });
      });
      var Rl, Ul, js, Zs, Qs = E(() => {
        "use strict";
        L();
        q();
        oe();
      ...
      ${f.setByOffset("global_idx", "value")};
        ...
        }, js = (e) => N({ axis: e.axis }), Zs = (e, t) => {
          let n = e.inputs;
          Rl(n), e.compute(Ul(e.inputs, t));
        };
      });
      var Vl, Nl, Xs, Ys, Js = E(() => {
        "use strict";
        L();
        q();
        K();
        Vl = (e) => {
          ...
          let h = (y) => {
            ...
            I.push(A);
            let B = [{ name: "output_size", type: "u32" }, { name: "M", type: "u32" }, { name: "N", type: "u32" }, { name: "K", type: "u32" }, { name: "alpha", type: "f32" }, { name: "beta", type: "f32" }];
            return `
  ...
  ${y.mainStart()}
    ...
    output[global_idx] = value;
      ...
      `, I = "value += tile_a[local_id.y][k] * tile_b[k][local_id.x];");
            let B = t.alpha === 1 ? "" : "value *= uniforms.alpha;";
            return `
  ...
  ${y.mainStart([u, u, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
          ...
          Vl(e.inputs), e.compute(Nl(e.inputs, t));
        };
      });
      var Me, We, tt, nt, Ll, Wl, Gl, Hl, ql, Fl, Kl, jl, ea, ta, na = E(() => {
        "use strict";
        L();
        q();
        oe();
        K();
        [Me, We, tt, nt] = [0, 1, 2, 3], Ll = (e) => {
          if (e[0].dims.length !== 4)
...
`, Kl = (e, t, n) => (() => {
        ...
        `;
        ...
        })() + `${e.setByOffset("global_idx", "result")}`, jl = (e, t) => {
          ...
          t.format === "NHWC" && (i = [e[0].dims[0], e[1].dims[1], e[1].dims[2], e[0].dims[3]], [Me, We, tt, nt] = [0, 3, 1, 2]);
  ...
  ${c.mainStart()}
    ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${Kl(s, a, t)}
          ...
          Ll(e.inputs), e.compute(jl(e.inputs, t));
        }, ta = (e) => N({ alignCorners: e.align_corners, mode: e.mode, paddingMode: e.padding_mode, format: e.format });
      });
      var ge, Xl, oa, ra, Yl, ht, ia, rr = E(() => {
        "use strict";
        L();
        q();
        oe();
        ...
        K();
        De();
        ge = (e, t) => e.length > t && e[t].dims.length > 0 ? e[t] : void 0, Xl = (e, t) => {
        ...
        }, oa = (e) => N({ ...e }), ra = N({ perm: [0, 2, 1, 3] }), Yl = (e, t, n, r, o, i, s) => {
  ...
  ${c.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
          ...
          if (s && x.size(s.dims) > 0) {
            ...
            return u = Yl(e, i, s, t, r, n * o, a), u = u.reshape([t, r, n, o]), n === 1 || r === 1 ? u : e.compute(ce(u, ra.perm), { inputs: [u], outputs: [-1] })[0];
          } else
            return i.dims.length === 3 && (u = i.reshape([t, r, n, o])), n === 1 || r === 1 ? u : e.compute(ce(u, ra.perm), { inputs: [u], outputs: [-1] })[0];
        }, ia = (e, t) => {
          let n = Xl(e.inputs, t), r = e.inputs[0], o = ge(e.inputs, 1), i = ge(e.inputs, 2), s = ge(e.inputs, 3), a = ge(e.inputs, 4), u = ge(e.inputs, 5), d = ge(e.inputs, 6), l = ge(e.inputs, 7);
          if (r.dims.length === 5)
            throw new Error("Packed QKV is not implemented");
          if ((o == null ? void 0 : o.dims.length) === 5)
            throw new Error("Packed KV is not implemented");
          let c = o && i && o.dims.length === 4 && i.dims.length === 4, p = ht(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, r, s, 0);
          if (c)
            return et(e, p, o, i, a, void 0, d, l, u, n);
          if (!o || !i)
            throw new Error("key and value must be provided");
          let f = ht(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.headSize, o, s, n.hiddenSize), m = ht(e, n.batchSize, n.numHeads, n.kvSequenceLength, n.vHeadSize, i, s, 2 * n.hiddenSize);
          et(e, p, f, m, a, void 0, d, l, u, n);
        };
      });
      var Jl, ec, tc, nc, or, sa, aa, ir = E(() => {
        "use strict";
        L();
        q();
        oe();
...
`)}
  ...
  ${m.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
          ...
          Jl(e.inputs);
          let n = e.inputs.length === 1 ? t : ec(e.inputs, t);
          e.compute(or(e.inputs, n), { inputs: [0] });
        }, aa = (e) => {
      ...
      var rc, an, ua, sr = E(() => {
        ...
        ${b.mainStart(Ke)}
          ...
          return { name: "RotaryEmbedding", shaderCache: { hint: N({ interleaved: n }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: h, getRunData: () => ({ outputs: [{ dims: e[0].dims, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(x.size(p) / Ke) }, programUniforms: m }) };
        }, ua = (e, t) => {
          rc(e.inputs, t), e.compute(an(e.inputs, t));
        };
      });
      var oc, ic, da, sc, la, ca = E(() => {
        "use strict";
        oe();
        L();
        Qt();
        ...
        }, ic = N({ perm: [0, 2, 1, 3] }), da = (e, t, n) => {
          let r = t, o = n.kvNumHeads;
          return t.dims.length === 3 && n.kvSequenceLength !== 0 && (r = t.reshape([n.batchSize, n.kvSequenceLength, o, n.headSize]), r = e.compute(ce(r, ic.perm), { inputs: [r], outputs: [-1] })[0]), r;
        }, sc = (e, t, n, r) => {
  ...
  `;
          ...
          if (((_a2 = e.inputs[1]) == null ? void 0 : _a2.dims.length) === 5)
            throw new Error("Packed KV is not implemented");
          let r = e.inputs[0], o = e.inputs[1] && e.inputs[1].dims.length > 0 ? e.inputs[1] : void 0, i = e.inputs[2] && e.inputs[2].dims.length > 0 ? e.inputs[2] : void 0, s = e.inputs[3] && e.inputs[3].dims.length !== 0 ? e.inputs[3] : void 0, a = e.inputs[4] && e.inputs[4].dims.length !== 0 ? e.inputs[4] : void 0, u = e.inputs.length > 4 ? e.inputs[5] : void 0, d = e.inputs.length > 5 ? e.inputs[6] : void 0, l = n.kvNumHeads ? n.kvNumHeads : n.numHeads, c = N({ axis: 2, numOutputs: 3, splitSizes: [n.numHeads * n.headSize, l * n.headSize, l * n.headSize] }), [p, f, m] = !o && !i ? e.compute(or([r], c), { inputs: [r], outputs: [-1, -1, -1] }) : [r, o, i], h, b;
          if (t.doRotary) {
            let w = e.compute(sc(n.batchSize, n.sequenceLength, u, d), { inputs: [u, d], outputs: [-1] })[0], v = e.inputs[7], $ = e.inputs[8], T = N({ interleaved: t.rotaryInterleaved !== 0, numHeads: n.numHeads, rotaryEmbeddingDim: 0, scale: t.scale }), I = [p, w, v, $], A = [-1];
            h = e.compute(an(I, T), { inputs: I, outputs: A })[0], I.splice(0, 1, f);
            let B = N({ interleaved: t.rotaryInterleaved !== 0, numHeads: n.kvNumHeads, rotaryEmbeddingDim: 0, scale: t.scale });
            b = e.compute(an(I, B), { inputs: I, outputs: A })[0];
          }
          let y = ht(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, t.doRotary ? h : p, void 0, 0), g = da(e, t.doRotary ? b : f, n), _ = da(e, m, n);
          et(e, y, g, _, void 0, void 0, s, a, void 0, n, u, d);
        };
      });
      var pa, ac, uc, ma, fa = E(() => {
        "use strict";
        L();
        q();
        De();
        K();
        pa = (e, t, n, r, o, i, s, a) => {
          let u = Q(i), d = u === 1 ? "f32" : `vec${u}f`, l = u === 1 ? "vec2f" : `mat2x${u}f`, c = o * s, p = 64;
          c === 1 && (p = 256);
  ...
  ${g.mainStart(p)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
          ...
          let r = t[0].dims, o = r, i = 2, s = r[0], a = r[1], u = x.sizeFromDimension(r, i), d = Q(u), l = x.size(o) / d, c = pa(e, t[0], t[1], t[2], s, u, a, n.epsilon), p = [s, a, u / d], f = [s, a], m = ["type", "none"], h = (b) => {
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${_.setByOffset("global_idx", "value")};
          ...
          let r = t[0].dims, o = r, i = r[0], s = r[r.length - 1], a = x.sizeFromDimension(r, 1) / s, u = Q(s), d = x.size(o) / u, l = [{ type: 12, data: a }, { type: 12, data: Math.floor(s / u) }], c = ["type", "type"], p = false, f = [0, r.length - 1];
          for (let y = 0; y < r.length - 2; y++)
            p = p || r[y + 1] !== 1, f.push(y + 1);
          p = p && r[r.length - 1] !== 1;
          let m = p ? e.compute(ce(e.inputs[0], f), { inputs: [e.inputs[0]], outputs: [-1] })[0] : e.inputs[0].reshape(Array.from({ length: r.length }, (y, g) => r[f[g]])), h = pa(e, m, t[1], t[2], i, a, s, n.epsilon), b = (y) => {
            let g = te(t[0].dataType), _ = u === 1 ? "vec2f" : `mat${u}x2f`, w = (T) => {
  ...
  ${y.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${w(0)}, ${w(1)});
          ...
          t.format === "NHWC" ? uc(e, e.inputs, t) : ac(e, e.inputs, t);
        };
      });
      var dc, lc, ha, ga = E(() => {
        "use strict";
       ...
       Got scale size of ${c} and bias size of ${p}`);
          ...
          let m = Q(l), h = ["type", "type"], b = [{ type: 12, data: d }, { type: 1, data: l }, { type: 12, data: Math.floor(l / m) }, { type: 1, data: t.epsilon }];
          s && h.push("type");
          let y = n > 1, g = n > 2, _ = (v) => {
            let $ = te(e[0].dataType), T = [S("x", e[0].dataType, e[0].dims, m), S("scale", i.dataType, i.dims, m)];
  ...
  ${v.mainStart()}
    ...
    ${g ? "inv_std_output[global_idx] = inv_std_dev" : ""};
          ...
          dc(e.inputs), e.compute(lc(e.inputs, t, e.outputCount));
        };
      });
      var cc, ya, ba = E(() => {
        "use strict";
        ...
        cc = (e) => {
          ...
          cc(e.inputs);
          let t = Ee.calcShape(e.inputs[0].dims, e.inputs[1].dims, true);
          if (!t)
            throw new Error("Can't use matmul on the given tensors");
          let n = t[t.length - 1], r = e.inputs[0].dims[e.inputs[0].dims.length - 1];
          if (n < 8 && r < 8)
            e.compute(tn(e.inputs, { activation: "" }, t));
          else {
            ...
            if (i !== 1 && o === 1 && s === 1) {
              ...
              e.compute(ft(l, { activation: "" }, t, d), { inputs: l });
            } else
              e.compute(ft(e.inputs, { activation: "" }, t));
          }
        };
      });
      var pc, mc, fc, _a, wa, $a = E(() => {
        "use strict";
        L();
        q();
        oe();
        ...
        pc = (e, t) => {
          ...
          let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = Q(t.k), f = Q(l), m = Q(s), h = a.concat([o, s]), b = o > 1 && s / m % 2 === 0 ? 2 : 1, y = x.size(h) / m / b, g = 64, _ = [], w = [u, o, i / p], v = x.convertShape(e[1].dims).slice();
          v.splice(-1, 1, l / f), _.push(...P(w)), _.push(...P(v)), _.push(...P(e[2].dims)), e.length === 4 && _.push(...P(x.convertShape(e[3].dims)));
          let $ = [u, o, s / m];
          _.push(...P($));
          let T = (I) => {
            let A = w.length, B = S("a", e[0].dataType, A, p), M = S("b", 12, v.length, f), V = S("scales", e[2].dataType, e[2].dims.length), z = [B, M, V], G = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
            G && z.push(G);
            let re = $.length, D = C("output", e[0].dataType, re, m), R = te(e[0].dataType), j = (() => {
              switch (p) {
                case 1:
                  return `array<${R}, 8>`;
                case 2:
        ...
        ${I.mainStart([g, 1, 1])}
          ...
          let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = Q(t.k), f = Q(l), m = a.concat([o, s]), h = 128, b = s % 8 === 0 ? 8 : s % 4 === 0 ? 4 : 1, y = h / b, g = y * f * 8, _ = g / p, w = g / t.blockSize, v = x.size(m) / b, $ = [], T = [u, o, i / p], I = x.convertShape(e[1].dims).slice();
          I.splice(-1, 1, l / f), $.push(...P(T)), $.push(...P(I)), $.push(...P(e[2].dims)), e.length === 4 && $.push(...P(x.convertShape(e[3].dims)));
          let A = [u, o, s];
          $.push(...P(A));
          let B = (M) => {
            let V = T.length, z = S("a", e[0].dataType, V, p), G = S("b", 12, I.length, f), re = S("scales", e[2].dataType, e[2].dims.length), D = [z, G, re], R = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
            R && D.push(R);
            let j = A.length, W = C("output", e[0].dataType, j), ie = te(e[0].dataType), me = () => {
              switch (p) {
                case 1:
                  return `
        ...
        ${M.mainStart([y, b, 1])}
          ...
          return { name: "BlockwiseMatMulNBits32", shaderCache: { hint: `${t.blockSize};${p};${f};${y};${b}`, inputDependencies: Array(e.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: m, dataType: c }], dispatchGroup: { x: v }, programUniforms: $ }), getShaderSource: B };
        }, _a = (e, t) => {
          pc(e.inputs, t), t.blockSize === 32 && e.adapterInfo.isVendor("intel") && e.adapterInfo.isArchitecture("gen-12lp") ? e.compute(fc(e.inputs, t)) : e.compute(mc(e.inputs, t));
        }, wa = (e) => N(e);
      });
      var hc, gc, yc, bc, _c, wc, $c, vc, va, xa = E(() => {
        "use strict";
        L();
        q();
        K();
      ...
      `;
          ...
          switch (n.mode) {
            case 0:
              return gc(e, t, n.pads.length);
            case 1:
              return yc(e, t, n.pads.length);
            case 2:
          ...
          let a = ["rank"], u = (d) => {
            let l = C("output", e[0].dataType, n.length), c = S("x", e[0].dataType, r.length), p = c.type.value, f = wc(l, r.length, t), m = [{ name: "output_size", type: "u32" }, { name: "pads", type: "i32", length: t.pads.length }];
          ...
          hc(e.inputs);
          let n = vc(e.inputs, t);
          e.compute($c(e.inputs, n), { inputs: [0] });
        };
      });
      var un, Sa, Ta, Ia, Ca, xc, Sc, Aa, Ea, ka, Pa, za, Ba, Oa, Da, Ma, Ra, Ua, Va, Na = E(() => {
        "use strict";
        $e();
        L();
        q();
        ...
        un = (e) => {
          ...
          Fe.adjustPoolAttributes(n, o, s, a, u, d);
          let l = Fe.computePoolOutputShape(n, o, a, u, s, d, t.autoPad), c = Object.assign({}, t);
        ...
        }, Ca = (e) => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`, xc = (e) => `${Ca(e)};${e.countIncludePad}`, Sc = (e) => `${Ca(e)};${e.storageOrder};${e.dilations}`, Aa = (e) => ({ format: e.format, autoPad: ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][e.auto_pad], ceilMode: e.ceil_mode, kernelShape: e.kernel_shape, strides: e.strides, pads: e.pads }), Ea = (e, t, n, r) => {
          let [o, i] = Sa(t, r, n), s = S("x", t.dataType, t.dims.length), a = s.type.value, u = "value += x_val;", d = "";
          o.countIncludePad ? d += `value /= ${a}(uniforms.kernelSize);` : d += `value /= ${a}(i32(uniforms.kernelSize) - pad);`;
          let [l, c, p, f, m] = Ta(i, o);
          l.push(...P(t.dims, i));
          let h = ["rank"];
          return { name: e, shaderCache: { hint: `${r.cacheKey};${p};${f};${m}`, inputDependencies: h }, getRunData: () => ({ outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(x.size(i) / 64) }, programUniforms: l }), getShaderSource: (b) => Ia(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m) };
        }, ka = (e) => {
          let t = e.count_include_pad !== 0, n = Aa(e);
          if (n.ceilMode !== 0)
            throw new Error("using ceil() in shape computation is not yet supported for AveragePool");
          let r = { countIncludePad: t, ...n, cacheKey: "" };
          return { ...r, cacheKey: xc(r) };
        }, Pa = (e, t) => {
          un(e.inputs), e.compute(Ea("AveragePool", e.inputs[0], false, t));
        }, za = { autoPad: "", ceilMode: 0, countIncludePad: false, kernelShape: [], strides: [], pads: [], storageOrder: 0, dilations: [] }, Ba = (e) => {
          let t = e.format;
          return { format: t, ...za, cacheKey: t };
        }, Oa = (e, t) => {
          un(e.inputs), e.compute(Ea("GlobalAveragePool", e.inputs[0], true, t));
        }, Da = (e, t, n, r) => {
          let [o, i] = Sa(t, r, n), s = `
      value = max(x_val, value);
    `, a = "", u = S("x", t.dataType, t.dims.length), d = ["rank"], [l, c, p, f, m] = Ta(i, o);
          return l.push(...P(t.dims, i)), { name: e, shaderCache: { hint: `${r.cacheKey};${p};${f};${m}`, inputDependencies: d }, getRunData: () => ({ outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(x.size(i) / 64) }, programUniforms: l }), getShaderSource: (h) => Ia(h, u, t.dims.length, i.length, o, s, a, t.dataType === 10 ? -65504 : -1e5, c, p, f, m) };
        }, Ma = (e, t) => {
          un(e.inputs), e.compute(Da("MaxPool", e.inputs[0], false, t));
        }, Ra = (e) => {
          let t = e.storage_order, n = e.dilations, r = Aa(e);
          if (t !== 0)
            throw new Error("column major storage order is not yet supported for MaxPool");
          if (r.ceilMode !== 0)
            throw new Error("using ceil() in shape computation is not yet supported for MaxPool");
          let o = { storageOrder: t, dilations: n, ...r, cacheKey: "" };
          return { ...o, cacheKey: Sc(o) };
        }, Ua = (e) => {
          let t = e.format;
          return { format: t, ...za, cacheKey: t };
        }, Va = (e, t) => {
          un(e.inputs), e.compute(Da("GlobalMaxPool", e.inputs[0], true, t));
        };
      });
      var Ic, Cc, La, Wa, Ga = E(() => {
        "use strict";
        L();
        q();
        oe();
        ...
        Ic = (e, t) => {
          ...
          let n = x.normalizeAxis(t.axis, e[0].dims.length), r = e[0].dataType, o = r === 3, i = e[0].dims, s = e[1].dataType, a = x.size(i), u = r === 3 || r === 2, d = u ? [Math.ceil(x.size(e[0].dims) / 4)] : e[0].dims, l = e[1].dims, c = e.length > 2 ? e[2] : void 0, p = c ? u ? [Math.ceil(x.size(c.dims) / 4)] : c.dims : void 0, f = l.length === 0 || l.length === 1 && l[0] === 1, m = f === false && l.length === 1, h = Q(a), b = f && (!u || h === 4), y = b ? h : 1, g = b && !u ? h : 1, _ = S("input", u ? 12 : r, d.length, g), w = S("scale", s, l.length), v = c ? S("zero_point", u ? 12 : r, p.length) : void 0, $ = C("output", s, i.length, y), T = [_, w];
          v && T.push(v);
          let I = [d, l];
          c && I.push(p);
          let A = [{ type: 12, data: a / y }, { type: 12, data: n }, { type: 12, data: t.blockSize }, ...P(...I, i)], B = (M) => {
            let V = [{ name: "output_size", type: "u32" }, { name: "axis", type: "u32" }, { name: "block_size", type: "u32" }];
            return `
      ...
      ${$.setByOffset("global_idx", `${$.type.value}(x_value - zero_point_value) * scale_value`)};
          ...
          return { name: "DequantizeLinear", shaderCache: { hint: t.cacheKey, inputDependencies: v ? ["rank", "rank", "rank"] : ["rank", "rank"] }, getShaderSource: B, getRunData: () => ({ outputs: [{ dims: i, dataType: s }], dispatchGroup: { x: Math.ceil(a / y / 64), y: 1, z: 1 }, programUniforms: A }) };
        }, La = (e, t) => {
          Ic(e.inputs, t), e.compute(Cc(e.inputs, t));
        }, Wa = (e) => N({ axis: e.axis, blockSize: e.blockSize });
      });
      var Ac, Ec, Ha, qa = E(() => {
        "use strict";
        $e();
        ...
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
          ...
          let t = 0, n = 0, r = 0;
          e.inputs[0].dataType === 6 ? (t = e.inputs[0].getInt32Array()[0], n = e.inputs[1].getInt32Array()[0], r = e.inputs[2].getInt32Array()[0]) : e.inputs[0].dataType === 1 && (t = e.inputs[0].getFloat32Array()[0], n = e.inputs[1].getFloat32Array()[0], r = e.inputs[2].getFloat32Array()[0]), J.webgpu.validateInputContent && Ac(t, n, r), e.compute(Ec(t, n, r, e.inputs[0].dataType), { inputs: [] });
        };
      });
      var kc, Fa, Ka, Pc, ja, Za, Qa = E(() => {
        "use strict";
        L();
        q();
        oe();
    ...
    data_offset += u32((u32(index) * element_count_dim));`, Ka = (e, t, n) => `for (var i = 0u; i < uniforms.num_updates_elements; i++) {
        ...
        ${kc(e.reduction, "output[data_offset + i]", "value", t)}
          ...
          let n = e[0].dims, r = e[1].dims, o = n, i = 1, s = Math.ceil(x.size(r) / i), a = r[r.length - 1], u = x.sizeFromDimension(n, a), d = x.sizeFromDimension(r, 0) / a, l = [{ type: 12, data: s }, { type: 12, data: a }, { type: 12, data: u }, ...P(e[1].dims, e[2].dims, o)], c = (p) => {
            let f = S("indices", e[1].dataType, e[1].dims.length), m = S("updates", e[2].dataType, e[2].dims.length, i), h = t.reduction !== "none" && t.reduction !== "" ? wo("output", e[0].dataType, o.length) : C("output", e[0].dataType, o.length, i);
            return `
  ...
  ${Ka(t, h.type.value, true)}
        ...
        }, ja = (e) => N({ reduction: e.reduction }), Za = (e, t) => {
          e.compute(Pc(e.inputs, t), { inputs: [e.inputs[1], e.inputs[2]], outputs: [] });
        };
      });
      var zc, Bc, Oc, Xa, Dc, Mc, Rc, Uc, Vc, Nc, Lc, Wc, Ya, Gc, Hc, qc, Fc, Kc, Ja, eu, tu = E(() => {
        "use strict";
        L();
        q();
        oe();
        ...
        zc = (e, t) => {
          ...
          if (a > 0 && e.length > a && e[a].dims.length === 1 && e[a].dims[0] > 0) {
            ...
            zc(r, t), t.axes.length > 0 && Bc(r, t.axes, d).forEach((l, c) => r[c] = l);
          }
...
`, Dc = (e, t) => `fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { ` + (() => {
        ...
        })() + "}", Mc = (e, t, n) => `fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {` + (() => {
          switch (e) {
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    depth = max(0, min(depth, ${n[a]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
          ...
          let s = e.dims, a = Rc(i, t.axes, s.length), u = Uc(s, r, o, t.axes), d = r.slice();
          r.length === 0 && (d = s.map((g, _) => g === 0 ? 1 : u[_] / g), t.keepAspectRatioPolicy !== "stretch" && (u = Vc(s, d, t)));
      ...
      ${(() => {
            ...
            ${(() => {
                  if (s.length === 2 || s.length === 4)
                    return `${Hc(c, l, s, u, d, a, t.cubicCoeffA, m, t.extrapolationValue, t.excludeOutside)}`;
...
`}
          ...
          Oc(e.inputs, t, i, n, r, o), e.compute(Fc(e.inputs[0], t, i, n, r, o), { inputs: [0] });
        }, eu = (e) => {
      ...
      var jc, Zc, nu, ru = E(() => {
        ...
        jc = (e) => {
          ...
          let o = t.simplified, i = e[0].dims, s = x.size(i), a = i, u = s, d = i.slice(-1)[0], l = r ? i.slice(0, -1).concat(1) : [], c = !o && e.length > 3, p = e.length > 4, f = r && n > 1, m = r && n > 2, h = n > 3, b = 64, y = Q(d), g = [{ type: 12, data: u }, { type: 12, data: y }, { type: 12, data: d }, { type: 1, data: t.epsilon }], _ = (v) => {
            ...
            let I = te(e[0].dataType), A = te(1, y);
            return `
      ...
      ${v.mainStart([b, 1, 1])}
        ...
        for (var i: u32 = 0; i < stride; i++) {
          ...
          jc(e.inputs);
          let r = [0];
          e.outputCount > 1 && r.push(-3), e.outputCount > 2 && r.push(-3), e.outputCount > 3 && r.push(3), e.compute(Zc(e.inputs, t, e.outputCount, false), { outputs: r });
        };
      });
      var Qc, dn, Xc, ou, Yc, Jc, iu, su, au = E(() => {
        "use strict";
        L();
        q();
        oe();
        ...
        Qc = (e, t) => {
        ...
        }, Yc = (e, t, n) => `fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
          ...
          let n = e[0].dims, r = x.size(n), o = t.axes.length > 0 ? x.normalizeAxes(t.axes, n.length) : [...Array(n.length).keys()], i = dn(e, 4);
          i.forEach((y) => y !== 0 || (() => {
            throw new Error("step cannot be 0");
          })), i.length === 0 && (i = Array(o.length).fill(1));
          let s = t.starts.map((y, g) => ou(y, g, n, o, i)), a = t.ends.map((y, g) => ou(y, g, n, o, i));
      ...
      var ep, tp, uu, du, lu = E(() => {
        ...
        ep = (e) => {
          ...
          let l = u.dims, c = l[i - 1], p = o / c, f = Q(c), m = c / f, h = 64;
          p === 1 && (h = 256);
          let b = (T, I) => I === 4 ? `max(max(${T}.x, ${T}.y), max(${T}.z, ${T}.w))` : I === 2 ? `max(${T}.x, ${T}.y)` : I === 3 ? `max(max(${T}.x, ${T}.y), ${T}.z)` : T, y = S("x", u.dataType, u.dims, f), g = C("result", u.dataType, u.dims, f), _ = y.type.value, w = te(u.dataType) === "f32" ? `var threadMax = ${_}(-3.402823e+38f);` : `var threadMax = ${_}(-65504.0h);`, v = (T) => `
      ...
      var cu, np, rp, op, pu, mu = E(() => {
        "use strict";
        L();
        q();
        K();
        cu = (e) => Array.from(e.getBigInt64Array(), Number), np = (e) => {
          if (!e || e.length !== 2)
          ...
          if (cu(e[1]).length !== e[0].dims.length)
          ...
          let n = e[0].dims, r = t ?? cu(e[1]), o = rp(n, r), i = x.size(o), s = e[0].dataType, a = S("input", s, n.length), u = C("output", s, o.length), d = (l) => `
      ...
      ${u.setByOffset("global_idx", a.getByIndices("input_indices"))}
          ...
          np(e.inputs), e.compute(op(e.inputs), { inputs: [0] });
        };
      });
      var ip, sp, fu, hu = E(() => {
        "use strict";
        ...
        ${d}
          ...
          if (i) {
            let d = Ee.calcShape(Ee.calcShape(t, n, false), r, false);
            if (!d)
              throw new Error("Can't perform where op on the given tensors");
            s = d, a = x.size(s);
          }
          let u = Math.ceil(a / 4);
          return { name: "Where", shaderCache: { inputDependencies: ["rank", "rank", "rank"] }, getShaderSource: (d) => ip(d, e, s, i, o), getRunData: () => ({ outputs: [{ dims: s, dataType: o }], dispatchGroup: { x: Math.ceil(a / 64 / 4) }, programUniforms: [{ type: 12, data: u }, ...P(r, t, n, s)] }) };
        }, fu = (e) => {
          e.compute(sp(e.inputs));
        };
      });
      var gu, yu = E(() => {
        "use strict";
      ...
      var ln, bu = E(() => {
        ...
        ln = class {
          ...
          build(t, n) {
            ...
            let s = $o(n, this.backend.device.limits), a = t.getShaderSource(s), u = `${o.join(`
`)}
...
${a}`, d = r.createShaderModule({ code: u, label: t.name });
      ...
      var _u = {};
      Ye(_u, { WebGpuBackend: () => ur });
      var ap, up, ar, ur, wu = E(() => {
        "use strict";
        $e();
        L();
        Ae();
        ...
        ap = (e, t) => {
          ...
          var _a2, _b;
          let r = e.name;
          return ((_a2 = e.shaderCache) == null ? void 0 : _a2.hint) && (r += "[" + e.shaderCache.hint + "]"), r += ":" + n + `:${ap(t, ((_b = e.shaderCache) == null ? void 0 : _b.inputDependencies) ?? new Array(t.length).fill("dims"))}`, r;
        }, ar = class {
          constructor(t) {
          ...
          async initialize(t, n) {
            ...
            i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"), i("shader-f16"), i("subgroups"), this.device = await n.requestDevice(o), this.adapterInfo = new ar(n.info || await n.requestAdapterInfo()), this.gpuDataManager = bo(this), this.programManager = new ln(this), this.kernels = /* @__PURE__ */ new Map(), this.kernelPersistentData = /* @__PURE__ */ new Map(), this.kernelCustomData = /* @__PURE__ */ new Map(), Vt(t.logLevel, !!t.debug), this.device.onuncapturederror = (s) => {
            ...
            this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), t = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(t, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, t, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && t.mapAsync(GPUMapMode.READ).then(() => {
              ...
              for (let o = 0; o < n.length / 2; o++) {
                ...
                if ((_a2 = this.env.webgpu.profiling) == null ? void 0 : _a2.ondata)
                  this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: c.map((y) => ({ dims: y.dims, dataType: Ce(y.dataType) })), outputsMetadata: p.map((y) => ({ dims: y.dims, dataType: Ce(y.dataType) })), kernelId: s, kernelType: u, kernelName: d, programName: l, startTime: h, endTime: b });
                else {
                  let y = "";
                  c.forEach((_, w) => {
                    y += `input[${w}]: [${_.dims}] | ${Ce(_.dataType)}, `;
                  });
                  let g = "";
                  p.forEach((_, w) => {
                    g += `output[${w}]: [${_.dims}] | ${Ce(_.dataType)}, `;
          ...
          run(t, n, r, o, i, s) {
            ...
            if (l) {
              ...
              l.forEach((I) => {
                ...
                if (A.length === 0)
                  return;
                let B = I.type === 10 ? 2 : 4, M, V;
                I.type === 10 ? (V = A.length > 4 ? 16 : A.length > 2 ? 8 : A.length * B, M = A.length > 4 ? 16 : B * A.length) : (V = A.length <= 2 ? A.length * B : 16, M = 16), _ = Math.ceil(_ / V) * V, w.push(_);
                let z = I.type === 10 ? 8 : 4;
                _ += A.length > 4 ? Math.ceil(A.length / z) * M : A.length * B;
              });
              let v = 16;
              _ = Math.ceil(_ / v) * v;
              let $ = new ArrayBuffer(_);
              l.forEach((I, A) => {
                let B = w[A], M = typeof I.data == "number" ? [I.data] : I.data;
                if (I.type === 6)
                  new Int32Array($, B, M.length).set(M);
                else if (I.type === 12)
                  new Uint32Array($, B, M.length).set(M);
                else if (I.type === 10)
                  new Uint16Array($, B, M.length).set(M);
                else if (I.type === 1)
                  new Float32Array($, B, M.length).set(M);
                else
                  throw new Error(`Unsupported uniform type: ${Ce(I.type)}`);
              });
            ...
            let h = this.programManager.normalizeDispatchGroupSize(d), b = h[1] === 1 && h[2] === 1, y = up(t, n, b), g = this.programManager.getArtifact(y);
          ...
          createDownloader(t, n, r) {
            return async () => {
              let o = await Un(this, t, n);
              return Lt(o.buffer, r);
            };
          }
          writeTimestamp(t) {
      ...
      var gt, dr, dp, vu = E(() => {
        ...
        gt = class e {
          ...
          compute(t, n) {
            var _a2;
            let r = ((_a2 = n == null ? void 0 : n.inputs) == null ? void 0 : _a2.map((a) => typeof a == "number" ? this.inputs[a] : a)) ?? this.inputs, o = (n == null ? void 0 : n.outputs) ?? [], i = (a, u, d) => new gt(this.module, u, this.output(a, d), d), s = (a, u) => {
              let d = Ne(a, u);
              if (!d)
                throw new Error(`Unsupported data type: ${a}`);
              let l = d > 0 ? this.backend.gpuDataManager.create(d).id : 0;
              return new gt(this.module, a, l, u);
            };
          ...
          if (e === "webgpu") {
            let i = (wu(), it(_u)).WebGpuBackend, s = new i();
      ...
      var lp, Tt, It, Ze, cp, xu, ut, Ct, At, Su, Et, kt, Pt, Sn = E(() => {
        "use strict";
        to();
        ro();
        L();
        ...
        En();
        lp = (e, t) => {
          ee()._OrtInit(e, t) !== 0 && X("Can't initialize onnxruntime.");
        }, Tt = async (e) => {
          lp(e.wasm.numThreads, lt(e.logLevel));
        }, It = async (e, t) => {
          var _a2, _b;
          (_b = (_a2 = ee()).asyncInit) == null ? void 0 : _b.call(_a2);
          {
            let n = (vu(), it($u)).init;
            if (t === "webgpu") {
        ...
        }, Ze = /* @__PURE__ */ new Map(), cp = (e) => {
          let t = ee(), n = t.stackSave();
          try {
            let r = t.PTR_SIZE, o = t.stackAlloc(2 * r);
            t._OrtGetInputOutputCount(e, o, o + r) !== 0 && X("Can't get session input/output count.");
            let s = r === 4 ? "i32" : "i64";
          ...
          let n = ee(), r = n.stackSave(), o = 0;
          try {
            let i = n.PTR_SIZE, s = n.stackAlloc(2 * i);
            n._OrtGetInputOutputMetadata(e, t, s, s + i) !== 0 && X("Can't get session input/output metadata.");
          ...
          let t = ee(), n = t._malloc(e.byteLength);
          if (n === 0)
          ...
          var _a2, _b, _c2, _d2;
          let n, r, o = ee();
          Array.isArray(e) ? [n, r] = e : e.buffer === o.HEAPU8.buffer ? [n, r] = [e.byteOffset, e.byteLength] : [n, r] = ut(e);
          let i = 0, s = 0, a = 0, u = [], d = [], l = [];
          try {
            if ([s, u] = await no(t), (t == null ? void 0 : t.externalData) && o.mountExternalData) {
              let w = [];
              for (let v of t.externalData) {
                let $ = typeof v == "string" ? v : v.path;
                w.push(ct(typeof v == "string" ? v : v.data).then((T) => {
            ...
            for (let w of (t == null ? void 0 : t.executionProviders) ?? [])
              if ((typeof w == "string" ? w : w.name) === "webnn") {
                if (o.shouldTransferToMLTensor = false, typeof w != "string") {
                  let $ = w, T = $ == null ? void 0 : $.context, I = $ == null ? void 0 : $.gpuDevice, A = $ == null ? void 0 : $.deviceType, B = $ == null ? void 0 : $.powerPreference;
                  T ? o.currentContext = T : I ? o.currentContext = await o.webnnCreateMLContext(I) : o.currentContext = await o.webnnCreateMLContext({ deviceType: A, powerPreference: B });
                } else
                  o.currentContext = await o.webnnCreateMLContext();
                break;
              }
            i = await o._OrtCreateSession(n, r, s), (_a2 = o.webgpuOnCreateSession) == null ? void 0 : _a2.call(o, i), i === 0 && X("Can't create a session."), (_b = o.jsepOnCreateSession) == null ? void 0 : _b.call(o), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
            let [c, p] = cp(i), f = !!(t == null ? void 0 : t.enableGraphCapture), m = [], h = [], b = [], y = [], g = [];
            for (let w = 0; w < c; w++) {
              let [v, $, T] = xu(i, w);
              v === 0 && X("Can't get an input name."), d.push(v);
              let I = o.UTF8ToString(v);
              m.push(I), b.push($ === 0 ? { name: I, isTensor: false } : { name: I, isTensor: true, type: Ce($), shape: T });
            }
            for (let w = 0; w < p; w++) {
              let [v, $, T] = xu(i, w + c);
              v === 0 && X("Can't get an output name."), l.push(v);
              let I = o.UTF8ToString(v);
              h.push(I), y.push($ === 0 ? { name: I, isTensor: false } : { name: I, isTensor: true, type: Ce($), shape: T });
              {
                if (f && (t == null ? void 0 : t.preferredOutputLocation) === void 0) {
                  g.push("gpu-buffer");
                  continue;
                }
                let A = typeof (t == null ? void 0 : t.preferredOutputLocation) == "string" ? t.preferredOutputLocation : ((_c2 = t == null ? void 0 : t.preferredOutputLocation) == null ? void 0 : _c2[I]) ?? "cpu";
            ...
            let _ = null;
            return g.some((w) => w === "gpu-buffer" || w === "ml-tensor") && (a = o._OrtCreateBinding(i), a === 0 && X("Can't create IO binding."), _ = { handle: a, outputPreferredLocations: g, outputPreferredLocationsEncoded: g.map((w) => An(w)) }), Ze.set(i, [i, d, l, _, f, false]), [i, m, h, b, y];
          } catch (c) {
            throw d.forEach((p) => o._OrtFree(p)), l.forEach((p) => o._OrtFree(p)), a !== 0 && o._OrtReleaseBinding(a) !== 0 && X("Can't release IO binding."), i !== 0 && o._OrtReleaseSession(i) !== 0 && X("Can't release session."), c;
          } finally {
            o._free(n), s !== 0 && o._OrtReleaseSessionOptions(s) !== 0 && X("Can't release session options."), u.forEach((c) => o._free(c)), (_d2 = o.unmountExternalData) == null ? void 0 : _d2.call(o);
          }
        }, At = (e) => {
          var _a2, _b, _c2;
          let t = ee(), n = Ze.get(e);
          ...
          let [r, o, i, s, a] = n;
          s && (a && t._OrtClearBoundOutputs(s.handle) !== 0 && X("Can't clear bound outputs."), t._OrtReleaseBinding(s.handle) !== 0 && X("Can't release IO binding.")), (_a2 = t.jsepOnReleaseSession) == null ? void 0 : _a2.call(t, e), (_b = t.webnnOnReleaseSession) == null ? void 0 : _b.call(t, e), (_c2 = t.webgpuOnReleaseSession) == null ? void 0 : _c2.call(t, e), o.forEach((u) => t._OrtFree(u)), i.forEach((u) => t._OrtFree(u)), t._OrtReleaseSession(r) !== 0 && X("Can't release session."), Ze.delete(e);
        }, Su = async (e, t, n, r, o, i, s = false) => {
          if (!e) {
            t.push(0);
            return;
          }
          let a = ee(), u = a.PTR_SIZE, d = e[0], l = e[1], c = e[3], p = c, f, m;
          ...
          if (c === "gpu-buffer") {
            ...
            if (Array.isArray(y)) {
              ...
              if (d !== "string" && g) {
                let _ = a.UTF8ToString(o);
                if (g(r, _)) {
                  let w = Je(d);
                  m = Ne(w, l), p = "ml-tensor";
                  let v = a.webnnCreateTemporaryTensor, $ = a.webnnUploadTensor;
                  if (!v || !$)
                    throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');
                  let T = await v(r, w, l);
                  $(T, new Uint8Array(y.buffer, y.byteOffset, y.byteLength)), f = T;
                } else
          ...
          try {
            ...
            let y = a._OrtCreateTensor(Je(d), f, m, b, l.length, An(p));
            y === 0 && X(`Can't create tensor for input/output. session=${r}, index=${i}.`), t.push(y);
          } finally {
            a.stackRestore(h);
          }
        }, Et = async (e, t, n, r, o, i) => {
          var _a2, _b, _c2, _d2;
          let s = ee(), a = s.PTR_SIZE, u = Ze.get(e);
          if (!u)
            throw new Error(`cannot run inference. invalid session id: ${e}`);
          let d = u[0], l = u[1], c = u[2], p = u[3], f = u[4], m = u[5], h = t.length, b = r.length, y = 0, g = [], _ = [], w = [], v = [], $ = s.stackSave(), T = s.stackAlloc(h * a), I = s.stackAlloc(h * a), A = s.stackAlloc(b * a), B = s.stackAlloc(b * a);
          try {
            [y, g] = eo(i);
            for (let z = 0; z < h; z++)
              await Su(n[z], _, v, e, l[t[z]], t[z], f);
            for (let z = 0; z < b; z++)
              await Su(o[z], w, v, e, c[r[z]], h + r[z], f);
            for (let z = 0; z < h; z++)
              s.setValue(T + z * a, _[z], "*"), s.setValue(I + z * a, l[t[z]], "*");
            for (let z = 0; z < b; z++)
              s.setValue(A + z * a, w[z], "*"), s.setValue(B + z * a, c[r[z]], "*");
            if (p && !m) {
              let { handle: z, outputPreferredLocations: G, outputPreferredLocationsEncoded: re } = p;
              if (l.length !== h)
                throw new Error(`input count from feeds (${h}) is expected to be always equal to model's input count (${l.length}).`);
              for (let D = 0; D < h; D++) {
                let R = t[D];
                await s._OrtBindInput(z, l[R], _[D]) !== 0 && X(`Can't bind input[${D}] for session=${e}.`);
              }
              for (let D = 0; D < b; D++) {
                let R = r[D];
                ((_a2 = o[D]) == null ? void 0 : _a2[3]) ? s._OrtBindOutput(z, c[R], w[D], 0) !== 0 && X(`Can't bind pre-allocated output[${D}] for session=${e}.`) : s._OrtBindOutput(z, c[R], 0, re[R]) !== 0 && X(`Can't bind output[${D}] to ${G[D]} for session=${e}.`);
              }
              Ze.set(e, [d, l, c, p, f, true]);
            }
            (_b = s.jsepOnRunStart) == null ? void 0 : _b.call(s, d), (_c2 = s.webnnOnRunStart) == null ? void 0 : _c2.call(s, d);
            let M;
            p ? M = await s._OrtRunWithBinding(d, p.handle, b, A, y) : M = await s._OrtRun(d, I, T, h, B, b, A, y), M !== 0 && X("failed to call OrtRun().");
            let V = [];
            for (let z = 0; z < b; z++) {
              let G = Number(s.getValue(A + z * a, "*"));
              if (G === w[z]) {
                V.push(o[z]);
                continue;
              }
              let re = s.stackSave(), D = s.stackAlloc(4 * a), R = false, j, W = 0;
              try {
                s._OrtGetTensorData(G, D, D + a, D + 2 * a, D + 3 * a) !== 0 && X(`Can't access output tensor data on index ${z}.`);
                let me = a === 4 ? "i32" : "i64", se = Number(s.getValue(D, me));
                W = s.getValue(D + a, "*");
                let H = s.getValue(D + a * 2, "*"), k = Number(s.getValue(D + a * 3, me)), U = [];
                for (let ae = 0; ae < k; ae++)
                  U.push(Number(s.getValue(H + ae * a, me)));
                s._OrtFree(H) !== 0 && X("Can't free memory for tensor dims.");
                let ne = U.reduce((ae, ue) => ae * ue, 1);
                j = Ce(se);
                let Re = p == null ? void 0 : p.outputPreferredLocations[r[z]];
                if (j === "string") {
                  if (Re === "gpu-buffer" || Re === "ml-tensor")
                    throw new Error("String tensor is not supported on GPU.");
                  let ae = [];
                  for (let ue = 0; ue < ne; ue++) {
                    let Xe = s.getValue(W + ue * a, "*"), bt = s.getValue(W + (ue + 1) * a, "*"), mr = ue === ne - 1 ? void 0 : bt - Xe;
                    ae.push(s.UTF8ToString(Xe, mr));
                  }
                  V.push([j, U, ae, "cpu"]);
                } else if (Re === "gpu-buffer" && ne > 0) {
                  let ae = s.jsepGetBuffer;
                  if (!ae)
                    throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');
                  let ue = ae(W), Xe = Ne(se, ne);
                  if (Xe === void 0 || !Rt(j))
                    throw new Error(`Unsupported data type: ${j}`);
                  R = true, V.push([j, U, { gpuBuffer: ue, download: s.jsepCreateDownloader(ue, Xe, j), dispose: () => {
                    s._OrtReleaseTensor(G) !== 0 && X("Can't release tensor.");
                  } }, "gpu-buffer"]);
                } else if (Re === "ml-tensor" && ne > 0) {
                  let ae = s.webnnEnsureTensor, ue = s.webnnIsInt64Supported;
                  if (!ae || !ue)
                    throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');
                  if (Ne(se, ne) === void 0 || !Ut(j))
                    throw new Error(`Unsupported data type: ${j}`);
                  if (j === "int64" && !ue(e))
                    throw new Error('preferredLocation "ml-tensor" for int64 output is not supported by current WebNN Context.');
                  let bt = await ae(e, W, se, U, false);
                  R = true, V.push([j, U, { mlTensor: bt, download: s.webnnCreateMLTensorDownloader(W, j), dispose: () => {
                    s.webnnReleaseTensorId(W), s._OrtReleaseTensor(G);
                  } }, "ml-tensor"]);
                } else {
                  let ae = Mt(j), ue = new ae(ne);
                  new Uint8Array(ue.buffer, ue.byteOffset, ue.byteLength).set(s.HEAPU8.subarray(W, W + ue.byteLength)), V.push([j, U, ue, "cpu"]);
                }
              } finally {
                s.stackRestore(re), j === "string" && W && s._free(W), R || s._OrtReleaseTensor(G), (_d2 = s.webnnOnRunEnd) == null ? void 0 : _d2.call(s, d);
              }
            }
            return p && !f && (s._OrtClearBoundOutputs(p.handle) !== 0 && X("Can't clear bound outputs."), Ze.set(e, [d, l, c, p, f, false])), V;
          } finally {
            s.stackRestore($), _.forEach((M) => s._OrtReleaseTensor(M)), w.forEach((M) => s._OrtReleaseTensor(M)), v.forEach((M) => s._free(M)), y !== 0 && s._OrtReleaseRunOptions(y), g.forEach((M) => s._free(M));
          }
        }, kt = (e) => {
          let t = ee(), n = Ze.get(e);
          if (!n)
          ...
          o === 0 && X("Can't get an profile file name."), t._OrtFree(o);
        }, Pt = (e) => {
          let t = [];
          for (let n of e) {
            let r = n[2];
      ...
      var Qe, ve, yt, pn, mn, cn, lr, cr, rt, ot, mp, Tu, Iu, Cu, Au, Eu, ku, Pu, pr = E(() => {
        "use strict";
        $e();
        Sn();
        Ve();
        xt();
        Qe = () => !!J.wasm.proxy && typeof document < "u", yt = false, pn = false, mn = false, cr = /* @__PURE__ */ new Map(), rt = (e, t) => {
          let n = cr.get(e);
          n ? n.push(t) : cr.set(e, [t]);
        }, ot = () => {
          if (yt || !pn || mn || !ve)
          ...
          switch (e.data.type) {
            case "init-wasm":
              yt = false, e.data.err ? (mn = true, lr[1](e.data.err)) : (pn = true, lr[0]()), cn && (URL.revokeObjectURL(cn), cn = void 0);
              break;
            case "init-ep":
            case "copy-from":
            case "create":
          ...
          if (!pn) {
            ...
            if (yt = true, Qe())
              return new Promise((e, t) => {
                ve == null ? void 0 : ve.terminate(), Xr().then(([n, r]) => {
                  try {
                    ve = r, ve.onerror = (i) => t(i), ve.onmessage = mp, lr = [e, t];
                    let o = { type: "init-wasm", in: J };
                    if (!o.in.wasm.wasmPaths && n) {
                      let i = zt();
                      i && (o.in.wasm.wasmPaths = i);
                    }
                    ve.postMessage(o), cn = n;
                  } catch (o) {
                    t(o);
                  }
                }, t);
            ...
            try {
              await St(J.wasm), await Tt(J), pn = true;
            } catch (e) {
              throw mn = true, e;
            } finally {
              yt = false;
          ...
          if (Qe())
            return ot(), new Promise((t, n) => {
              rt("init-ep", [t, n]);
              let r = { type: "init-ep", in: { epName: e, env: J } };
              ve.postMessage(r);
            });
          await It(J, e);
        }, Cu = async (e) => Qe() ? (ot(), new Promise((t, n) => {
          rt("copy-from", [t, n]);
      ...
      var zu, fp, fn, Bu = E(() => {
        ...
        zu = (e, t) => {
          ...
          async fetchModelAndCopyToWasmMemory(t) {
            return Cu(await ct(t));
          }
          async loadModel(t, n) {
            he();
            let r;
            typeof t == "string" ? r = await this.fetchModelAndCopyToWasmMemory(t) : r = t, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await Au(r, n), fe();
          }
          async dispose() {
            return Eu(this.sessionId);
          }
          async run(t, n, r) {
            he();
            let o = [], i = [];
            ...
            let u = o.map((p, f) => zu(p, () => `input "${this.inputNames[i[f]]}"`)), d = s.map((p, f) => p ? zu(p, () => `output "${this.outputNames[a[f]]}"`) : null), l = await ku(this.sessionId, i, u, a, d, r), c = {};
            for (let p = 0; p < l.length; p++)
              c[this.outputNames[a[p]]] = s[p] ?? fp(l[p]);
            return fe(), c;
          }
          startProfiling() {
          }
      ...
      var Du = {};
      Ye(Du, { OnnxruntimeWebAssemblyBackend: () => hn, initializeFlags: () => Ou, wasmBackend: () => hp });
      var Ou, hn, hp, Mu = E(() => {
        "use strict";
        $e();
        pr();
        Bu();
        Ou = () => {
          (typeof J.wasm.initTimeout != "number" || J.wasm.initTimeout < 0) && (J.wasm.initTimeout = 0);
          let e = J.wasm.simd;
          if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`), J.wasm.simd = false), typeof J.wasm.proxy != "boolean" && (J.wasm.proxy = false), typeof J.wasm.trace != "boolean" && (J.wasm.trace = false), typeof J.wasm.numThreads != "number" || !Number.isInteger(J.wasm.numThreads) || J.wasm.numThreads <= 0)
            if (typeof self < "u" && !self.crossOriginIsolated)
              J.wasm.numThreads = 1;
            else {
              let t = typeof navigator > "u" ? yn("node:os").cpus().length : navigator.hardwareConcurrency;
              J.wasm.numThreads = Math.min(4, Math.ceil((t || 1) / 2));
            }
        }, hn = class {
          async init(t) {
            Ou(), await Tu(), await Iu(t);
          }
      ...
      var yp = {};
      Ye(yp, { InferenceSession: () => Rr, TRACE: () => at, TRACE_FUNC_BEGIN: () => he, TRACE_FUNC_END: () => fe, Tensor: () => we, default: () => gp, env: () => J, registerBackend: () => Ue });
      $e();
      $e();
      $e();
      var Gr = "1.22.0-dev.20250409-89f8206ba4";
      var gp = xn;
      {
        let e = (Mu(), it(Du)).wasmBackend;
        Ue("webgpu", e, 5), Ue("webnn", e, 5), Ue("cpu", e, 10), Ue("wasm", e, 10);
      }
      Object.defineProperty(J.versions, "web", { value: Gr, enumerable: true });
      return it(yp);
    })();
